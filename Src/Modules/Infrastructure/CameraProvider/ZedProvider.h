 ...
 * @file ZedProvider.h
 *
 * This file declares a module that grabs images from the Zed sensor.
 *
 * @author -
 */
 ...
 class ZedProvider : public ZedProviderBase
 {
   static thread_local ZedProvider* theInstance; /**< The only instance of this module. */
   
 #ifdef TARGET_BOOSTER
   sl::Camera zed; /**< The ZED camera object */
   bool hasFrame = false; /**< Whether we've received at least one frame */
 #endif
