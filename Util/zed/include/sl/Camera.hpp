...
PLEASE READ THIS SOFTWARE LICENSE CAREFULLY. IF YOU DO NOT ACCEPT THIS SOFTWARE
LICENSE, DO NOT USE YOUR CAMERA. RETURN IT TO UNUSED TO STEREOLABS FOR A REFUND.
Contact STEREOLABS at support@stereolabs.com

1.    Definitions

"Authorized Accessory" means a STEREOLABS branded ZED, ZED 2, ZED2i, ZED Mini,
ZED X or ZED X Mini, and a STEREOLABS licensed, third party branded, ZED
hardware accessory whose packaging bears the official "Licensed for ZED" logo.
The ZED camera, ZED 2 camera and the ZED Mini camera are Authorized Accessories
solely for purpose of this Software license.
"Software" means the Software Development Kit, available on the stereolabs.com
website, and including any updates STEREOLABS may make available from time to
time.
"Unauthorized Accessories" means all hardware accessories other than an
Authorized Accessory.
"Unauthorized Software" means any software not distributed by STEREOLABS.
"You" means the user of a ZED, ZED 2, ZED2i, ZED Mini, ZED X or ZED X Mini
camera.
...
b.    As conditions to this Software license, You agree that:
        i.    You will use Your Software with ZED, ZED 2, ZED2i, ZED Mini, ZED X or
    ZED X Mini camera only and not with any other device (including). You will not
    use Unauthorized Accessories. They may not work or may stop working permanently
    after a Software update.
        ii.    You will not use or install any Unauthorized Software with an
    Authorized Accessory. If You do, Your ZED, ZED 2, ZED2i, ZED Mini, ZED X or ZED
    X Mini camera may stop working permanently at that time or after a later
    Software update.
        iii.    You will not attempt to defeat or circumvent any Software technical
    limitation, security, or anti-piracy system. If You do, Your ZED, ZED 2, ZED2i,
    ZED Mini, ZED X or ZED X Mini camera may stop working permanently at that time
    or after a later Software update.
        iv.    STEREOLABS may use technical measures, including Software updates, to
    limit use of the Software to the ZED, ZED 2, ZED2i, ZED Mini, ZED X or ZED X
    Mini camera, to prevent use of Unauthorized Accessories, and to protect the
    technical limitations, security and anti-piracy systems in the ZED, ZED 2,
    ZED2i, ZED Mini, ZED X or ZED X Mini camera.
        v.    STEREOLABS may update the Software from time to time without further
    notice to You, for example, to update any technical limitation, security, or
    anti-piracy system.

3.    Warranty
The Software is covered by the Limited Warranty for Your ZED, ZED 2, ZED2i, ZED
Mini, ZED X or ZED X Mini camera, and STEREOLABS gives no other guarantee,
warranty, or condition for the Software. No one else may give any guarantee,
warranty, or condition on STEREOLABS's behalf.
...
OR ANY INABILITY TO USE THE SOFTWARE. THESE EXCLUSIONS APPLY EVEN IF STEREOLABS
HAS BEEN ADVISED OF THE POSSIBILITY OF THESE DAMAGES, AND EVEN IF ANY REMEDY
FAILS OF ITS ESSENTIAL PURPOSE.

5.    Choice of Law
French law governs the interpretation of this Software license and any claim
that STEREOLABS has breached it, regardless of conflict of law principles.
...
namespace sl {
    ...
    public:
        ...
        /**
        \brief Copy the value of a std::string.
         */
        ...
        /**
        \brief Convert the sl::String into a bool.
         */
        explicit operator bool() const {
            return !empty(); // Will be true only if the string is not empty.
        }
        ...
        /**
        \brief Checks if the value of the current sl::String is lexicographically less than the value of another sl::String.
        \param s The sl::String to compare with the current sl::String.
        \return `true` if the current sl::String is lexicographically less than the other sl::String, otherwise `false`.
         */
        bool operator<(const String& s) const;

        /**
        \brief Checks if the value of the current sl::String is lexicographically greater than the value of another sl::String.
        \param s The sl::String to compare with the current sl::String.
        \return `true` if the current sl::String is lexicographically greater than the other sl::String, otherwise `false`.
         */
        bool operator>(const String& s) const;
    ...
    bool /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/
    saveJSONFile(const sl::String filepath, const sl::String& serialized_content, bool merge = false);
    bool /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ loadJSONFile(const sl::String filepath, sl::String& serialized_content);
     ...
     */
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ Resolution {
        /**
        ...
        /**
        \brief Generate a JSON Object (with the struct type as a key) containing the serialized struct, converted into a string
        \param serialized_content: output string containing the JSON Object
        \return True if file was successfully saved, otherwise false.
         */
        bool encode(String& serialized_content) const;

        /**
        \brief Fill the structure from the serialized json object contained in the input string
        \param serialized_content: input string containing the JSON Object
    ...
    public:
        ...
        inline bool contains(const Rect& target, bool proper = false) const {
            bool ret = false;
            if (!proper)
                ret = (x <= target.x) && (y <= target.y) && (x + width >= target.x + target.width)
                    && (y + height >= target.y + target.height);
            else
        ...
        inline bool isContained(const Resolution& resolution, bool proper = false) const {
            ...
            if ((resolution.width < 0) || (resolution.height < 0))
                return ret;
            if (!proper)
                ret = (x + width <= static_cast<size_t>(resolution.width)) && (y + height <= static_cast<size_t>(resolution.height));
            else
                ret = x > 0 && y > 0 && (x + width < static_cast<size_t>(resolution.width))
                    && (y + height < static_cast<size_t>(resolution.height));
            return ret;
        }
    };
    ...
    bool SL_CORE_EXPORT fromString(const String& unit_str, UNIT& unit);
    ...
    enum class COORDINATE_SYSTEM {
        IMAGE,                   /**< Standard coordinates system in computer vision.\n Used in OpenCV: see <a
                                    href="http://docs.opencv.org/2.4/modules/calib3d/doc/camera_calibration_and_3d_reconstruction.html">here</a>. */
    ...
    bool SL_CORE_EXPORT fromString(const String& coord_system_str, COORDINATE_SYSTEM& coord_system);
    ...
    enum class ERROR_CODE {
        ...
        SENSORS_DATA_REQUIRED
            = -3, /**< The input data does not contains the high frequency sensors data, this is usually because it requires newer
                     SVO/Streaming. In order to work this modules needs inertial data present in it input.*/
        ...
        NOT_ENOUGH_GPU_MEMORY = 3,   /**< Not enough GPU memory for this depth mode, try a different mode (such as \ref DEPTH_MODE
                                        "PERFORMANCE"), or increase the minimum depth value (see InitParameters::depth_minimum_distance).*/
        CAMERA_NOT_DETECTED = 4,     /**< No camera was detected.*/
        SENSORS_NOT_INITIALIZED = 5, /**< The MCU that controls the sensors module has an invalid serial number. You can try to recover it
                                        by launching the <b>ZED Diagnostic</b> tool from the command line with the option <code>-r</code>.*/
        SENSORS_NOT_AVAILABLE = 6,   /**< A camera with sensor is detected but the sensors (IMU, barometer, ...) cannot be opened. Only the
                                        \ref MODEL "MODEL::ZED" does not has sensors. Unplug/replug is required.*/
        INVALID_RESOLUTION
            = 7, /**< In case of invalid resolution parameter, such as an upsize beyond the original image size in Camera::retrieveImage. */
        LOW_USB_BANDWIDTH = 8, /**< Insufficient bandwidth for the correct use of the camera. This issue can occur when you use multiple
                                  cameras or a USB 2.0 port.*/
        CALIBRATION_FILE_NOT_AVAILABLE = 9, /**< The calibration file of the camera is not found on the host machine. Use <b>ZED
                                               Explorer</b> or <b>ZED Calibration</b> to download the factory calibration file.*/
        INVALID_CALIBRATION_FILE = 10, /**< The calibration file is not valid. Try to download the factory calibration file or recalibrate
                                          your camera using <b>ZED Calibration</b>.*/
        ...
        CUDA_ERROR = 18, /**< A CUDA error has been detected in the process, in Camera.grab() or Camera.retrieveXXX() only. Activate verbose
                            in Camera.open() for more info.*/
        ...
        INVALID_FUNCTION_CALL
            = 21, /**< The call of the function is not valid in the current context. Could be a missing call of Camera.open(). */
        CORRUPTED_SDK_INSTALLATION = 22, /**< The ZED SDK was not able to load its dependencies or some assets are missing. Reinstall the
                                            ZED SDK or check for missing dependencies (cuDNN, TensorRT). */
        ...
        INCOMPATIBLE_AREA_FILE = 25,     /**< The area file does not contain enough data to be used or the \ref DEPTH_MODE used during the
                                            creation of the area file is different from the one currently set. */
        CAMERA_FAILED_TO_SETUP = 26, /**< Failed to open the camera at the proper resolution. Try another resolution or make sure that the
                                        UVC driver is properly installed.*/
        CAMERA_DETECTION_ISSUE
            = 27, /**< Your camera can not be opened. Try replugging it to another port or flipping the USB-C connector (if there is one).*/
        CANNOT_START_CAMERA_STREAM = 28, /**< Cannot start the camera stream. Make sure your camera is not already used by another process
                                            or blocked by firewall or antivirus.*/
        NO_GPU_DETECTED = 29,            /**< No GPU found. CUDA is unable to list it. Can be a driver/reboot issue.*/
        PLANE_NOT_FOUND = 30, /**< Plane not found. Either no plane is detected in the scene, at the location or corresponding to the floor,
        ...
        MODULE_NOT_COMPATIBLE_WITH_CAMERA = 31, /**< The module you try to use is not compatible with your camera \ref MODEL. \note \ref
                                                   MODEL "MODEL::ZED" does not has an IMU and does not support the AI modules.*/
        ...
        DRIVER_FAILURE = 34, /**< The drivers initialization has failed. When using gmsl cameras, try restarting with sudo systemctl restart
     ...
     */
    enum class MODEL {
        ZED = 0,            /**< ZED camera model */
        ZED_M = 1,          /**< ZED Mini (ZED M) camera model */
        ZED2 = 2,           /**< ZED 2 camera model */
        ZED2i = 3,          /**< ZED 2i camera model */
        ZED_X = 4,          /**< ZED X camera model (120mm baseline) with dual global shutter AR0234 sensor*/
        ZED_XM = 5,         /**< ZED X Mini (50mm baseline)camera model with dual global shutter AR0234 sensor*/
        ZED_X_HDR = 6,      /**< ZED X HDR camera model (120mm baseline) with dual HDR rolling shutter ISX031 sensor*/
        ZED_X_HDR_MINI = 7, /**< ZED X HDR mini camera model (50mm baseline) with dual HDR rolling shutter ISX031 sensor*/
        ZED_X_HDR_MAX = 8,  /**< ZED X HDR Max camera model (170mm baseline) with dual HDR rolling shutter ISX031 sensor*/
        VIRTUAL_ZED_X = 11, /**< Virtual ZED-X generated from 2 ZED-XOne (Using ZED Media Server) */
        ...
        ZED_XONE_HDR = 32,  /**< ZED X One with HDR rolling shutter ISX031 sensor */
        ///@cond SHOWHIDDEN
        LAST = 33
        ///@endcond
    };
    ...
    /**
    \ingroup Core_group
    \brief Check the type of a camera model
    \return true if the specified camera model is a monocular camera
     */
    bool /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ isCameraOne(const sl::MODEL);
    ...
    enum class INPUT_TYPE {
        ...
        STREAM, /**< STREAM input mode (requires to use \ref Camera.enableStreaming "enableStreaming()" / \ref Camera.disableStreaming
                   "disableStreaming()"" on the "sender" side) */
    ...
    \note Similar to the sl::CalibrationParameters, those parameters are taken from the settings file (SNXXX.conf) and are modified during
    the sl::Camera.open() call when running a self-calibration). \note Those parameters given after sl::Camera.open() call, represent the
    camera matrix corresponding to rectified or unrectified images. \note When filled with rectified parameters, fx, fy, cx, cy must be the
    same for left and right camera once sl::Camera.open() has been called. \note Since distortion is corrected during rectification,
    distortion should not be considered on rectified images.
     */
    struct CameraParameters {
        /**
        ...
        CameraParameters scale(sl::Resolution const& output_resolution) const {
            ...
            float rx = static_cast<float>(output_resolution.width) / static_cast<float>(image_size.width);
            float ry = static_cast<float>(output_resolution.height) / static_cast<float>(image_size.height);
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const STREAMING_CODEC& codec);
    bool SL_CORE_EXPORT fromString(const sl::String& codec_str, STREAMING_CODEC& codec);

    inline std::ostream& operator<<(std::ostream& os, const STREAMING_CODEC& codec) {
        return os << toString(codec);
    }
    ///@endcond
    ...
    enum class SENSOR_TYPE {
        ...
        MAGNETOMETER,  /**< Three-axis magnetometer sensor to measure the orientation of the device with respect to the Earth's magnetic
                          field. */
    ...
    \ingroup Video_group
    \param serial_left : Serial number of the left camera.
    \param serial_right : Serial number of the right camera.
    ...
    */
    ...
    class SL_CORE_EXPORT InputType {
        ...
        friend class CameraOneImpl;
        friend struct InitParameters;
        friend struct InitParametersOne;
    ...
    public:
        ...
        enum class INPUT_TYPE {
            ...
            STREAM,      /**< STREAM input (requires to use \ref Camera.enableStreaming "enableStreaming()" / \ref Camera.disableStreaming
                            "disableStreaming()"" on the "sender" side) */
        ...
        /**
        \brief Set the input as the camera with specified id.
        \note The id is not related to the serial number of the camera. The id is assigned by the OS depending on the order the cameras are
        plugged. \warning Using id is not recommended if you have multiple cameras plugged in the system, prefer using the serial number
        instead. \param id : Id of the camera to open. The default, -1, will open the first available camera. A number >= 0 will try to open
        the camera with the corresponding id. \param bus_type : Whether the camera is a USB or a GMSL camera.
         */
        void setFromCameraID(int id = -1, sl::BUS_TYPE bus_type = sl::BUS_TYPE::AUTO);

        /**
        \brief Set the input as the camera with specified serial number.
        ...
        /**
        \brief Set the input as the ZED Ones with specified ids for a virtual stereo rig
        \param id_left : Id of the left ZED One camera to open.
        \param id_right : Id of the right ZED One camera to open.
        \param virtual_serial_number : Serial number of the virtual stereo rig to load its custom calibration
        ...
        A support function can be used, based on the ZED One serial number, to compute a valid virtual serial number: \ref
        sl::generateVirtualStereoSerialNumber \return error: true if there's an error
         */
        bool setVirtualStereoFromCameraIDs(int id_left, int id_right, unsigned int virtual_serial_number);

        /**
        \brief Set the input as the ZED Ones with specified serial numbers for a virtual stereo rig
        \param camera_left_serial_number : Serial number of the left ZED One camera to open.
        \param camera_right_serial_number : Serial number of the right ZED One camera to open.
        \param virtual_serial_number : Serial number of the virtual stereo rig to load its custom calibration
        \note: The virtual serial number must fall within an interval that reflects the Product ID range.
        This is necessary to avoid, for instance, downloading calibration data from an unrelated product.
        The valid range is 110000000 to 119999999.
        ...
        sl::generateVirtualStereoSerialNumber \return error: true if there's an error
         */
        bool setVirtualStereoFromSerialNumbers(
            unsigned int camera_left_serial_number,
        ...
        \param filename : Path to the file from which the parameters will be loaded  (extension '.yml' will be added at the end of the
        filename if not set). \return True if the file was successfully loaded, otherwise false.
        ...
        \note As the InitParameters files can be easily modified manually (using a text editor) this function allows you to test various
        settings without re-compiling your application.
         */
    ...
    private:
        ...
        sl::String configuration_right = "0";
        bool virtual_stereo_mode_ = false;
        unsigned int virtual_serial_number_ = 0;
    };

    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const InputType::INPUT_TYPE& input_type);
    bool SL_CORE_EXPORT fromString(const String& input_type_str, InputType::INPUT_TYPE& input_type);

    inline std::ostream& operator<<(std::ostream& os, const InputType::INPUT_TYPE& input_type) {
        return os << toString(input_type);
    }
    ///@endcond
    ...
    enum class OBJECT_DETECTION_MODEL {
        ...
        PERSON_HEAD_BOX_FAST, /**< Bounding box detector specialized in person heads particularly well suited for crowded environments. The
                                 person localization is also improved. */
        PERSON_HEAD_BOX_ACCURATE, /**< Bounding box detector specialized in person heads, particularly well suited for crowded environments.
                                     The person localization is also improved, more accurate but slower than the base model.*/
        CUSTOM_BOX_OBJECTS, /**< For external inference, using your own custom model and/or frameworks. This mode disables the internal
                               inference engine, the 2D bounding box detection must be provided. */
        CUSTOM_YOLOLIKE_BOX_OBJECTS, /**< For internal inference using your own custom YOLO-like model. This mode requires a onnx file to be
                                        passed in the ObjectDetectionParameters. This model will be used for inference. */
        ///@cond SHOWHIDDEN
        LAST
        ///@endcond
    };
    ...
    bool SL_CORE_EXPORT fromString(const sl::String& input_type_str, OBJECT_DETECTION_MODEL& input_type);
    ...
    bool SL_CORE_EXPORT fromString(const sl::String& input_type_str, BODY_TRACKING_MODEL& input_type);
    ...
    enum class AI_MODELS {
        ...
        MULTI_CLASS_ACCURATE_DETECTION, /**< Related to [sl::OBJECT_DETECTION_MODEL::MULTI_CLASS_BOX_ACCURATE](\ref
        ...
        PERSON_HEAD_ACCURATE_DETECTION,   /**< Related to [sl::OBJECT_DETECTION_MODEL::PERSON_HEAD_BOX_ACCURATE](\ref
                                             OBJECT_DETECTION_MODEL)*/
        REID_ASSOCIATION,                 /**< Related to sl::BatchParameters.enable*/
        NEURAL_LIGHT_DEPTH,               /**< Related to [sl::DEPTH_MODE::NEURAL_LIGHT](\ref DEPTH_MODE)*/
    ...
    It is defined in a row-major order, it means that, in the value buffer, the entire first row is stored first, followed by the entire
    ...
    public:
        ...
        \param mat : sl::Matrix3f to move.
         */
        Matrix3f(Matrix3f&& mat) noexcept;
         ...
         */
        Matrix3f& operator=(Matrix3f&& mat) noexcept;
    ...
    public:
        ...
        /**
        \brief Move constructor.
        \param mat : sl::Matrix4f to move.
         */
        Matrix4f(Matrix4f&& mat) noexcept;
        ...
        /**
        \brief Gets access to a specific point in the sl::Matrix4f (read).
        \param u : Row to get the value from.
        \param v : Column to get the value from.
        \return The value at the u, v coordinates.
         */
        ...
        \return [sl::ERROR_CODE::SUCCESS](\ref ERROR_CODE) if the inverse has been computed, [sl::ERROR_CODE::FAILURE](\ref ERROR_CODE) is
        not (det = 0).
         */
        ERROR_CODE inverse();
    ...
    public:
         ...
         */
        _FCT_CPU_GPU_ Vector2(const Vector2<T>& vec) {
            this->x = vec.x;
            this->y = vec.y;
        }
         ...
         */
        inline _FCT_CPU_GPU_ Vector2& setValues(const T* vals) {
            this->x = vals[0];
            this->y = vals[1];
            return *this;
        }
        ...
        /**
        \brief Prevent operator from being called by temporaries (such as rvalue)
         */
    ...
    public:
         ...
         */
        _FCT_CPU_GPU_ Vector3(const Vector3<T>& vec) {
            this->x = vec.x;
            this->y = vec.y;
            this->z = vec.z;
        }
         ...
         */
        _FCT_CPU_GPU_ Vector3(const Vector2<T>& vec, const T d = 0) {
            this->x = vec.x;
            this->y = vec.y;
            this->z = d;
        }
         ...
         */
        _FCT_CPU_GPU_ Vector3(const Vector4<T>& vec) {
            this->x = vec.x;
            this->y = vec.y;
            this->z = vec.z;
        }
         ...
         */
        inline _FCT_CPU_GPU_ Vector3<T>& setValues(const T* vals) {
            this->x = vals[0];
            this->y = vals[1];
            this->z = vals[2];
            return *this;
        ...
        inline _FCT_CPU_GPU_ friend bool operator==(const Vector3<T>& itself, const Vector3<T>& b) {
            return (itself.x == b.x) && (itself.y == b.y) && (itself.z == b.z);
        }
    ...
    public:
         ...
         */
        _FCT_CPU_GPU_ Vector4(const Vector4<T>& vec) {
            this->x = vec.x;
            this->y = vec.y;
            this->z = vec.z;
            this->w = vec.w;
         ...
         */
        _FCT_CPU_GPU_ Vector4(const Vector4<T>& vec, const T d) {
            this->x = vec.x;
            this->y = vec.y;
            this->z = vec.z;
            this->w = d;
         ...
         */
        _FCT_CPU_GPU_ Vector4(const Vector3<T>& vec, const T d = 0) {
            this->x = vec.x;
            this->y = vec.y;
            this->z = vec.z;
            this->w = d;
         ...
         */
        inline _FCT_CPU_GPU_ Vector4<T>& setValues(const T* vals) {
            this->x = vals[0];
            this->y = vals[1];
            this->z = vals[2];
            this->w = vals[3];
        ...
        inline _FCT_CPU_GPU_ friend bool operator==(const Vector4<T>& itself, const Vector4<T>& b) {
            return (itself.x == b.x) && (itself.y == b.y) && (itself.z == b.z) && (itself.w == b.w);
        }
        ...
        static inline _FCT_CPU_GPU_ float distance(const Vector4<T>& a, const Vector4<T>& b) {
            return sqrt(
                pow(a.x - b.x, static_cast<T>(2)) + pow(a.y - b.y, static_cast<T>(2)) + pow(a.z - b.z, static_cast<T>(2))
                + pow(a.w - b.w, static_cast<T>(2))
            );
        }
    ...
    struct Timestamp {
         ...
         */
        inline uint64_t getNanoseconds() const {
            return data_ns;
        }
...
namespace std {
    ...
    // Specialize std::hash for sl::String

    template <>
    struct hash<sl::String> {

        std::size_t operator()(const sl::String& s) const noexcept {
            return std::hash<std::string> {}(std::string(s.get()));
        }
    };
} // namespace std
...
namespace sl {
    ...
    enum class MEM {
        ...
        BOTH = 3, /**< Data will be stored on the GPU and CPU.*/
        LAST = 4
    };
    ...
    /*@cond SHOWHIDDEN*/ size_t SL_CORE_EXPORT getStep_internal(const size_t step_bytes, const size_t sizeofn); /*@endcond*/
    ...
    The CPU and GPU buffer aren't automatically synchronized for performance reasons, you can use \ref updateCPUfromGPU / \ref
    updateGPUfromCPU to do it. \n If you are using the GPU side of the sl::Mat object, you need to make sure to call \ref free before
    destroying the sl::Camera object. \n The destruction of the sl::Camera object deletes the CUDA context needed to free the GPU sl::Mat
    memory.
     */
    ...
    public:
        ...
        \param stream : Specifies the GPU stream to be used to enable asynchronous overlapping. Default: 0 (synchronous)
        \param GPU_id : Specifies the GPU id to be used. Default: 0 (first GPU).
        \return [sl::ERROR_CODE::SUCCESS](\ref ERROR_CODE) if everything went well, [sl::ERROR_CODE::FAILURE](\ref ERROR_CODE) otherwise.
        ...
        \param compression_level : Level of compression between 0 (lowest compression == highest size == highest quality(jpg)) and 100
        (highest compression == lowest size == lowest quality(jpg)). \note Specific/default value for compression_level = -1 : This will set
        the default quality for PNG(30) or JPEG(5). \note \b compression_level is only supported for U8_Cx sl::MAT_TYPE. \return
        [sl::ERROR_CODE::SUCCESS](\ref ERROR_CODE) if everything went well, [sl::ERROR_CODE::FAILURE](\ref ERROR_CODE) otherwise.
        ...
        \param stream : a cuda stream to put the compute to (default 0).
        \return [sl::ERROR_CODE::SUCCESS](\ref ERROR_CODE) if everything went well, [sl::ERROR_CODE::FAILURE](\ref ERROR_CODE) otherwise.

        \note This method is templated for \ref sl::uchar1, \ref sl::uchar2, \ref sl::uchar3, \ref sl::uchar4, \ref sl::float1, \ref
        sl::float2, \ref sl::float3, \ref sl::float4, \ref sl::char4, \ref sl::ushort1.
         */
        template <typename T>
        ...
        /**
        \brief Get the value of a specific point in the matrix.
        \param x : Column of the point to get the value from.
        \param y : Row of the point to get the value from.
        \param value : Pointer to the value to be filled.
        ...
        /** \brief Prevent method from being called by temporaries (such as rvalue) */
         ...
         */
        template <typename N>
        inline size_t getStep(const MEM memory_type = MEM::CPU) const {
            return getStep_internal(getStepBytes(memory_type), sizeof(N));
        }
         ...
         */
        static ERROR_CODE convertColor(
            Mat& mat1,
            Mat& mat2,
            bool swap_RB_channels,
            bool remove_alpha_channels,
            sl::MEM memory = sl::MEM::CPU,
    ...
    inline std::ostream& operator<<(std::ostream& os, const sl::Mat& m) {
        return os << m.getInfos();
    }
    ///@endcond
    ...
    \param mean : mean, statistic to normalized the pixel values, applied AFTER the scale. For instance for imagenet statistics the mean
    would be sl::float3(0.485, 0.456, 0.406) \param stddev : standard deviation, statistic to normalized the pixel values, applied AFTER the
    scale. For instance for imagenet statistics the standard deviation would be sl::float3(0.229, 0.224, 0.225) \param keep_aspect_ratio :
    indicates if the original width and height ratio should be kept using padding (sometimes refer to as letterboxing) or if the image
    should be stretched \param swap_RB_channels : indicates if the Red and Blue channels should be swapped (RGB<->BGR or RGBA<->BGRA) \param
    stream : a cuda stream to put the compute
     */
    ERROR_CODE SL_CORE_EXPORT blobFromImage(
        sl::Mat& image_in,
        sl::Mat& tensor_out,
    ...
    \param images_in : input images to convert
    ...
    stream : a cuda stream to put the compute
     */
    ERROR_CODE SL_CORE_EXPORT blobFromImages(
        std::vector<sl::Mat>& images_in,
        sl::Mat& tensor_out,
        sl::Resolution resolution_out,
        float scalefactor = 1 / 255.,
        sl::float3 mean = sl::float3(0, 0, 0),
    ...
    public:
        ...
        \return Euler angles created from the sl::Rotation values representing the rotations around the X, Y and Z axes using YZX
        convention.
         */
    ...
    public:
        ...
        \param orient : \ref sl::Orientation to be get the normalized orientation from.
        \return Another \ref sl::Orientation object equal to \ref normalise.
         */
    ...
    It can be used to create any type of Matrix4x4 or sl::Matrix4f that must be specifically used for handling a rotation and position
    ...
    public:
        ...
        /**
        \brief Move constructor.
        \param motion : sl::Transform to move.
         */
        ...
        /**
        \brief Copy assignment operator from Matrix4f.
         */
        ...
        \param radian : Whether the angle will be returned in radian or degree.
        \return Euler angles created from the sl::Transform values as a sl::float3 representing the rotations around the X, Y and Z axes
        using YZX convention.
         */
        float3 getEulerAngles(bool radian = true) const;
    ...
    \note The calibration/rectification process, called during sl::Camera.open(), is using the raw parameters defined in the SNXXX.conf
    file, where XXX is the serial number of the camera. \note Those values may be adjusted or not by the self-calibration to get a proper
    image alignment. \note After sl::Camera.open() is done (with or without self-calibration activated), most of the stereo parameters
    (except baseline of course) should be 0 or very close to 0. \note It means that images after rectification process (given by
    sl::Camera.retrieveImage()) are aligned as if they were taken by a "perfect" stereo camera, defined by the new
    sl::CalibrationParameters. \warning CalibrationParameters are returned in \ref COORDINATE_SYSTEM "sl::COORDINATE_SYSTEM::IMAGE", they
    are not impacted by the \ref InitParameters "sl::InitParameters::coordinate_system".
     */
    ...
    struct SensorParameters {
        ...
        float random_walk;    /**< \brief Random walk derived from the Allan Variance given as continuous (frequency-independent).\note The
                                 units will be expressed in `sensor_unit / √(Hz)`.\note `NAN` if the information is not available. */
    ...
    \warning sl::CalibrationParameters are returned in sl::COORDINATE_SYSTEM::IMAGE, they are not impacted by the
    sl::InitParameters.coordinate_system.
     */
    struct CameraConfiguration {
        /**
    ...
    public:
        ...
        /**
        \brief Returns the 3x1 rotation vector (obtained from 3x3 rotation matrix using Rodrigues formula) corresponding to the current
        sl::Pose. \return Rotation vector created from the sl::Pose values.
         */
        float3 getRotationVector() const;
        ...
        \param radian : Whether the angle will be returned in radian or degree.
        \return Euler angles created from the sl::Pose values as a sl::float3 representing the rotations around the X, Y and Z axes using
        YZX convention.
         */
        float3 getEulerAngles(bool radian = true) const;
     ...
     */
    class /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ Landmark {
    public:
        /**
     ...
     * @class Landmark2D
     * @ingroup PositionalTracking_group
     * @brief Represents the projection of a 3d landmark in the image.
     */
    class /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ Landmark2D {
    public:
        /**
         * @brief Unique identifier of the corresponding landmark.
         */
        uint64_t id;
    ...
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ SensorsData {
        ...
        struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ TemperatureData {
            ...
            \param temperature : Reference to the temperature value to be filled.
        ...
        struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ MagnetometerData {
            ...
            \note To calibrate the magnetometer sensor, please use \b ZED \b Sensor \b Viewer tool after placing the camera in the final
            ...
            \note The magnetic North Pole has an offset with respect to the geographic North Pole, depending on the geographic position of
            the camera. \note To get a correct magnetic heading, the magnetometer sensor must be calibrated using \b ZED \b Sensor \b Viewer
            tool.
             */
        ...
        If the value is 1, the data has been taken during the same time than a frame has been acquired by the left sensor (the time
        precision is linked to the IMU rate, therefore 800Hz == 1.3ms). \n If the value is 0, the data has not been taken during a frame
        acquisition.
         */
     ...
     */
    /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ Rotation
    computeRotationMatrixFromGravity(sl::float3 axis_to_align, sl::float3 gravity_vector);
    ...
    \return Matrix3f : transformation matrix, to apply to a \ref float3 point simply multiply by this matrix (pt_coord_dst = tf_matrix *
    pt_coord_src).
     */
    /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ Matrix3f
    getCoordinateTransformConversion3f(COORDINATE_SYSTEM coord_system_src, COORDINATE_SYSTEM coord_system_dst);

    /*!
    \brief Get the coordinate transform conversion matrix to change coordinate system.
    \param coord_system_src : the source coordinate system.
    \param coord_system_dst : the destination coordinate system.
    \return Matrix4f : transformation matrix, to apply to a \ref float4 point simply multiply by this matrix (pt_coord_dst = tf_matrix *
    pt_coord_src).
     */
    /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ Matrix4f
    getCoordinateTransformConversion4f(COORDINATE_SYSTEM coord_system_src, COORDINATE_SYSTEM coord_system_dst);

    /*!
    \brief Change the coordinate system of a matrix.
    \param floatMat : (in/out) matrix to transform, can be either a \ref MAT_TYPE::F32_C4 (the fourth value will be ignored as it contained
    the color information) or a \ref MAT_TYPE::F32_C3.
    ...
    */
    /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ ERROR_CODE
    convertCoordinateSystem(Mat& floatMat, COORDINATE_SYSTEM coord_system_src, COORDINATE_SYSTEM coord_system_dst, MEM mem = MEM::CPU);
     ...
     */
    /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ ERROR_CODE
    convertCoordinateSystem(Transform& motionMat, COORDINATE_SYSTEM coord_system_src, COORDINATE_SYSTEM coord_system_dst);
    ...
    \param floatMat : (in/out) matrix to transform, can be either a \ref MAT_TYPE::F32_C4 (the fourth value will be ignored as it contained
    the color information), \ref MAT_TYPE::F32_C3 or a \ref MAT_TYPE::F32_C1.
    ...
    */
    /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ ERROR_CODE
    convertUnit(Mat& floatMat, UNIT unit_src, UNIT unit_dst, MEM mem = MEM::CPU);
    ...
    bool SL_CORE_EXPORT fromString(const sl::String& object_class_str, OBJECT_CLASS& object_class);
    ...
    /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ int getObjectSubClassAsCOCO(const OBJECT_SUBCLASS object_type);
    ...
    enum class OBJECT_FILTERING_MODE {
        ...
        NMS3D, /**< The ZED SDK will remove objects that are in the same 3D position as an already tracked object (independent of class id).
                */
        NMS3D_PER_CLASS, /**< The ZED SDK will remove objects that are in the same 3D position as an already tracked object of the same
                            class id. */
        ///@cond SHOWHIDDEN
        LAST
        ///@endcond
    ...
    bool SL_CORE_EXPORT fromString(const sl::String& object_filtering_mode_str, OBJECT_FILTERING_MODE& object_filtering_mode);
    ...
    \ingroup Object_group
    \brief Lists of supported presets for maximum acceleration allowed for a given tracked object.
     */
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const OBJECT_ACCELERATION_PRESET& object_acceleration_preset);
    bool SL_CORE_EXPORT
    fromString(const sl::String& object_acceleration_preset_str, OBJECT_ACCELERATION_PRESET& object_acceleration_preset);

    inline std::ostream& operator<<(std::ostream& os, const OBJECT_ACCELERATION_PRESET& object_acceleration_preset) {
        return os << toString(object_acceleration_preset);
    }
    ///@endcond
    ...
    bool SL_CORE_EXPORT fromString(const sl::String& body_format_str, BODY_FORMAT& body_format);
    ...
    bool SL_CORE_EXPORT fromString(const sl::String& body_selection_str, BODY_KEYPOINTS_SELECTION& body_selection);
    ...
    enum class REFERENCE_FRAME {
        ...
        CAMERA, /**< The transform of sl::Pose will contain the motion with reference to the previous camera frame (previously called
                   POSE).*/
        ///@cond SHOWHIDDEN
        LAST
        ///@endcond
    ...
    bool SL_CORE_EXPORT fromString(const sl::String& ref_frame_str, REFERENCE_FRAME& ref_frame);
    ...
    public:
        ...
        It is forwarded from sl::CustomBoxObjectData when using [sl::OBJECT_DETECTION_MODEL::CUSTOM_BOX_OBJECTS](\ref
        OBJECT_DETECTION_MODEL).
         */
        int raw_label = 0;
        ...
        \note It is defined in ```sl::InitParameters.coordinate_units / s``` and expressed in
        ...
        /**
        \brief Mask defining which pixels which belong to the object (in \ref bounding_box_2d and set to 255) and those of the background
        (set to 0). \warning The mask information is only available for tracked objects ([sl::OBJECT_TRACKING_STATE::OK](\ref
        OBJECT_TRACKING_STATE)) that have a valid depth. \warning Otherwise, the mask will not be initialized (```mask.isInit() ==
        false```).
         */
        sl::Mat mask;
        ...
        /**
        \brief 2D bounding box of the head of the object (a person) represented as four 2D points starting at the top left corner and
        rotation clockwise. \note Expressed in pixels on the original image resolution, ```[0, 0]``` is the top left corner. \warning Not
        available with [sl::OBJECT_DETECTION_MODEL::MULTI_CLASS_BOX_XXX](\ref OBJECT_DETECTION_MODEL).
         */
    ...
    public:
        ...
        /**
        \brief Expected maximum acceleration of the tracked object.
        ...
        By default, let the ZED SDK interpret the object acceleration.
        Unit is m/s^2.
         */
    ...
    /**
    \ingroup Object_group
    \brief Class that store externally detected objects with mask.

    The objects can be ingested with sl::Camera.ingestCustomMaskObjects() to extract 3D and tracking information over time.
     */
    class /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ CustomMaskObjectData {
    public:
        /**
        \brief Default constructor.
         */
    ...
    public:
        ...
        In a multi camera setup, multiple cameras can be used to detect objects and multiple detector having similar output layout can see
        the same object. Therefore, Fusion will fuse together the outputs received by multiple detectors only if they are part of the same
        \ref fused_objects_group_name.
         */
        sl::String fused_objects_group_name;

        /**
        \brief Method that looks for a given object id in the current objects list.
        \param[out] objectData : sl::ObjectData to fill if the search succeeded.
        \param[in] objectDataId : Id of the sl::ObjectData to search.
   ...
   \brief Class containing data of a detected body/person such as its \ref bounding_box, \ref id and its 3D \ref position.
    ...
    public:
        ...
        /**
        \brief Mask defining which pixels which belong to the body/person (in \ref bounding_box_2d and set to 255) and those of the
        background (set to 0). \warning The mask information is only available for tracked bodies ([sl::OBJECT_TRACKING_STATE::OK](\ref
        OBJECT_TRACKING_STATE)) that have a valid depth. \warning Otherwise, the mask will not be initialized (```mask.isInit() ==
        false```).
         */
        sl::Mat mask;
        ...
        \note Expressed in pixels on the original image resolution, ```[0, 0]``` is the top left corner.
        \warning In some cases, eg. body partially out of the image, some keypoints can not be detected. They will have negatives
        coordinates.
         */
        ...
        \warning In some cases, eg. body partially out of the image or missing depth data, some keypoints can not be detected. They will
        have non finite values.
         */
        std::vector<sl::float3> keypoint;

        /**
        \brief 2D bounding box of the head of the body/person represented as four 2D points starting at the top left corner and rotation
        clockwise. \note Expressed in pixels on the original image resolution, ```[0, 0]``` is the top left corner.
         */
        std::vector<sl::uint2> head_bounding_box_2d;
        ...
        \warning In some cases, eg. body partially out of the image or missing depth data, some keypoints can not be detected. Their
        covariances will be 0.
         */
        std::vector<std::array<float, 6>> keypoint_covariances;

        /**
        \brief Vector of local position (position of the child keypoint with respect to its parent expressed in its parent coordinate frame)
        for each keypoint. \note They are expressed in \ref sl::REFERENCE_FRAME::CAMERA or \ref sl::REFERENCE_FRAME::WORLD. \warning Not
        available with \ref sl::BODY_FORMAT::BODY_18.
         */
        ...
        \warning Not available with \ref sl::BODY_FORMAT::BODY_18.
         */
   ...
   \brief Class containing the results of the body tracking module.
    ...
    public:
        ...
        \note It depends on the GPU hardware support, the sl::BodyTrackingParameters.allow_reduced_precision_inference input parameter and
        the model support.
         */
        ...
        \param[out] bodyData : sl::BodyData to fill if the search succeeded.
        \param[in] bodyDataId : Id of the sl::BodyData to search.
        \return True if found, otherwise false.
         */
    ...
    /**
     * \ingroup Body_group
     * \brief Semantic of human body parts and order of sl::BodyData::keypoint for \ref sl::BODY_FORMAT "sl::BODY_FORMAT::BODY_18".
     */
    ...
    /**
     * \ingroup Body_group
     * \brief Semantic of human body parts and order of sl::BodyData::keypoint for \ref sl::BODY_FORMAT "sl::BODY_FORMAT::BODY_34".
     */
    ...
    /**
     * \ingroup Body_group
     * \brief Semantic of human body parts and order of sl::BodyData::keypoint for \ref sl::BODY_FORMAT "sl::BODY_FORMAT::BODY_38".
     */
    ...
    /**
     * \ingroup Body_group
     * \brief Lists links of human body keypoints for \ref sl::BODY_FORMAT "sl::BODY_FORMAT::BODY_18".
     * \n Useful for display.
     */
    ...
    /**
     * \ingroup Body_group
     * \brief Lists links of human body keypoints for \ref sl::BODY_FORMAT "sl::BODY_FORMAT::BODY_34".
     * \n Useful for display.
     */
    ...
    /**
     * \ingroup Body_group
     * \brief Lists links of human body keypoints for \ref sl::BODY_FORMAT "sl::BODY_FORMAT::BODY_38".
     * \n Useful for display.
     */
    ...
    public:
        ...
        enum class COMM_TYPE {
            LOCAL_NETWORK, /**< The sender and receiver are on the same local network and communicate by RTP.\n The communication can be
                              affected by the local network load.*/
        ...
        \brief Loads a set of parameters from the values contained in a previously \ref save() "saved" file.
        \param filename : Path to the file from which the parameters will be loaded (extension '.yml' will be added at the end of the
        filename if not detected). \return True if the file was successfully loaded, otherwise false.
         */
        bool load(String filename);
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const CommunicationParameters::COMM_TYPE& com);
    bool SL_CORE_EXPORT fromString(const String& unit_str, CommunicationParameters::COMM_TYPE& com);

    inline std::ostream& operator<<(std::ostream& os, const CommunicationParameters::COMM_TYPE& com) {
        return os << toString(com);
    }
    ///@endcond
   ...
   \struct HealthStatus
   \ingroup Video_group
   \brief Structure containing the self diagnostic results of the system
     *
     * That information can be retrieved by sl::Camera::getHealthStatus(), and enabled by sl::InitParameters::enable_image_validity_check
     * \n
     ...
     *
     */
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ HealthStatus {
        /**
         ...
         *
         * \note: Frame tearing is currently not detected. Advanced blur detection requires heavier processing and is enabled only when
        setting sl::Initparameters::enable_image_validity_check to 3 and above
         */
         ...
         * This is based on the scene illuminance in LUX for the ZED X cameras series (available with \ref
        VIDEO_SETTINGS::SCENE_ILLUMINANCE)
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const HealthStatus& h);

    inline std::ostream& operator<<(std::ostream& os, const HealthStatus& h) {
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const TIME_REFERENCE& time_reference);
    ...
    enum class POSITIONAL_TRACKING_STATE {
        ...
        FPS_TOO_LOW,           /**< The effective FPS is too low to provide accurate motion tracking results. Consider adjusting performance
                                  parameters (e.g., depth mode, camera resolution) to improve tracking quality. */
        SEARCHING_FLOOR_PLANE, /**< The camera is currently searching for the floor plane to establish its position relative to it. The
                                  world reference frame will be set afterward. */
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const POSITIONAL_TRACKING_STATE& track_state);
    ...
    enum class ODOMETRY_STATUS {
        /**
         * @brief The positional tracking module successfully tracked from the previous frame to the current frame.
         */
        OK = 0,
        /**
         * @brief The positional tracking module cannot track the current frame.
         */
        UNAVAILABLE = 1,
        /**
         * @brief The positional tracking failed to track the current frame because it could not find enought features.
         */
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const ODOMETRY_STATUS& track_state);
    ...
    enum class SPATIAL_MEMORY_STATUS {
        /**
         * @brief Deprecated: This state is no longer in use for GEN_3.
         */
        OK = 0,
        /**
         * @brief Displayed whenever the system has found a loop closure, relocalized within the area map or corrected after a
         *  sudden localization loss.
         */
        LOOP_CLOSED = 1,
        /**
         * @brief Deprecated: This state is no longer in use for GEN_3.
        ...
        SEARCHING = 2,
        /**
         * @brief Displayed when the spatial memory is turned off.
         */
        OFF = 3,
        /**
         * @brief Displayed until the cameras has acquired enough memory (Initial Area Mapping) or has found its first loop closure
         *  and is localized in the loaded area map (Lifelong Mapping/Localization). Users need to keep moving the camera for it to
         *  get updated.
         */
        INITIALIZING = 4,
        /**
         * @brief Displayed when the camera is localized within the loaded area map.
         */
        KNOWN_MAP = 5,
        /**
         * @brief Displayed when the robot is mapping (Initial Area Mapping) or when the robot is getting out of the area map
         *  bounds (Lifelong Mapping). Displayed as “Tracking” when in exploratory mode with SLAM engaged.
         */
        MAP_UPDATE = 6,
        /**
         * @brief Displayed when localization cannot operate anymore (camera completely obstructed, sudden localization jumps after being
         *  localized) in Mapping/ Localization modes. It can also include the case where the camera jumps or is located out of map bounds
         * in Localization mode. This should be an indicator for users to stop the robot.
         */
        LOST = 7,
        LAST
    };
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const SPATIAL_MEMORY_STATUS& track_state);
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const POSITIONAL_TRACKING_FUSION_STATUS& track_state);
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const PositionalTrackingStatus& track_state);
     ...
     */
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ BatchParameters {
        /**
        ...
        \note Specifying a short latency will limit the search (falling in timeout) for previously seen object ids but will be closer to
        real time output. \note Specifying a long latency will reduce the change of timeout in re-identification but increase difference
        with live output.
         */
        float latency = 2.f;
        ...
        /**
        \brief Saves the current set of parameters into a file to be reloaded with the \ref load() method.
        \param filename : Name of the file which will be created to store the parameters (extension '.json' will be added if not set).
        \return True if the file was successfully saved, otherwise false.
        \warning For security reasons, the file must not already exist.
        \warning In case a file already exists, the method will return false and existing file will not be updated.
         */
        ...
        /**
        \brief Loads a set of parameters from the values contained in a previously \ref save() "saved" file.
        \param filename : Path to the file from which the parameters will be loaded (extension '.json' will be added at the end of the
        filename if not detected). \return True if the file was successfully loaded, otherwise false.
         */
        bool load(String filename);
    ...
    \note Parameters can be adjusted by the user.
     */
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ ObjectDetectionParameters {
        /**
        ...
        When `detection_model` is \ref OBJECT_DETECTION_MODEL::CUSTOM_YOLOLIKE_BOX_OBJECTS, a onnx model must be passed so that the ZED SDK
        can optimize it for your GPU and run inference on it.

        The resulting optimized model will be saved for re-use in the future.

        \attention - The model must be a YOLO-like model.
        \attention - The caching uses the deserialized `custom_onnx_file` along with your GPU specs to decide whether to use the cached
        optimized model or to optimize the passed onnx model. If you change the weights of the onnx file and pass the same path, the ZED SDK
        will detect the difference and optimize the new model.
        ...
        /**
        \brief Resolution to the YOLO-like onnx file for custom object detection ran in the ZED SDK. This resolution defines the input
        tensor size for dynamic shape ONNX model only. The batch and channel dimensions are automatically handled, it assumes it's color
        images like default YOLO models.

        \note This parameter is only used when detection_model is \ref OBJECT_DETECTION_MODEL::CUSTOM_YOLOLIKE_BOX_OBJECTS and the provided
        ONNX file is using dynamic shapes. \attention - Multiple model only support squared images
        ...
        \note The value cannot be greater than sl::InitParameters.depth_maximum_distance and its unit is defined in
        sl::InitParameters.coordinate_units.
         */
        float max_range = -1.f;
        ...
        /**
        \brief Prediction duration of the ZED SDK when an object is not detected anymore before switching its state to
        [sl::OBJECT_TRACKING_STATE::SEARCHING](\ref OBJECT_TRACKING_STATE).
        ...
        \note During this time, the object will have [sl::OBJECT_TRACKING_STATE::OK](\ref OBJECT_TRACKING_STATE) state even if it is not
        detected. \note The duration is expressed in seconds. \warning \ref prediction_timeout_s will be clamped to 1 second as the
        prediction is getting worse with time. \warning Setting this parameter to 0 disables the ZED SDK predictions.
         */
        ...
        It might increase the initial optimization time and could include downloading calibration data or calibration cache and slightly
        reduce the accuracy. \note The fp16 is automatically enabled if the GPU is compatible and provides a speed up of almost x2 and
        reduce memory usage by almost half, no precision loss. \note This setting allow int8 precision which can speed up by another x2
        factor (compared to fp16, or x4 compared to fp32) and half the fp16 memory usage, however some accuracy could be lost. \note The
        accuracy loss should not exceed 1-2% on the compatible models. \note The current compatible models are all
        [sl::AI_MODELS::HUMAN_BODY_XXXX](\ref AI_MODELS).
         */
    ...
    \note Parameters can be adjusted by the user.
     */
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ ObjectDetectionRuntimeParameters {
        /**
        ...
        \n Default: 20.f
        \note If the scene contains a lot of objects, increasing the confidence can slightly speed up the process, since every object
        instance is tracked. \note \ref detection_confidence_threshold is used as a fallback when
        sl::ObjectDetectionRuntimeParameters.object_class_detection_confidence_threshold is partially set.
         */
        ...
        \param detection_confidence_threshold Confidence threshold.
        \param object_class_filter Object class filter.
        \param object_class_detection_confidence_threshold Map of confidence threshold per classes.
         */
    ...
    \note Parameters can be adjusted by the user.
     */
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ CustomObjectDetectionProperties {
        /**
        ...
        */
        ...
        /**
         * Comparison operator ==
         * @param props CustomObjectDetectionProperties to compare
         * @return true if the two struct are identical
         */
    ...
    \note Parameters can be adjusted by the user.
     */
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ CustomObjectDetectionRuntimeParameters {
        /**
        \brief Global object detection properties.

        \note \ref object_detection_properties is used as a fallback when
        sl::CustomObjectDetectionRuntimeParameters.object_class_detection_properties is partially set.
         */
         ...
         */
        std::unordered_map<int /* class id */, CustomObjectDetectionProperties> object_class_detection_properties;

        /**
        \brief Default constructor.

        \param object_detection_properties Global object properties, when not specified in object_class_detection_properties.
        \param object_class_detection_properties Object properties per classes.
         */
        CustomObjectDetectionRuntimeParameters(
            const CustomObjectDetectionProperties& object_detection_properties = CustomObjectDetectionProperties {},
            const std::unordered_map<int, CustomObjectDetectionProperties>& object_class_detection_properties
            = std::unordered_map<int, CustomObjectDetectionProperties> {}
        );
        ...
        /**
         * Comparison operator ==
         * @param params CustomObjectDetectionRuntimeParameters to compare
         * @return true if the two struct are identical
         */
    ...
    \note Parameters can be adjusted by the user.
     */
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ BodyTrackingParameters {
        /**
        \brief Id of the module instance.
    ...
    \note Parameters can be adjusted by the user.
     */
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ BodyTrackingRuntimeParameters {
        /**
        \brief Confidence threshold.
        ...
        BodyTrackingRuntimeParameters(
            float detection_confidence_threshold = 20.f,
    ...
    /**
        ...
        \note Parameters can be adjusted by the user.
     */
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ PlaneDetectionParameters {
        /**
    ...
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ RegionOfInterestParameters {
        /**
    ...
    public:
        ...
        /**
         * @brief The heading (orientation) of the pose in radians. It indicates the direction in which the object or observer is facing,
         * with 0 degrees corresponding to North and increasing in a counter-clockwise direction.
         */
        double heading;
    ...
    public:
        ...
        \param longitude Longitude coordinate.
        \param altitude Altitude coordinate.
        \param in_radian If the inputs are expressed in radians or in degrees.
         */
        void setCoordinates(double latitude, double longitude, double altitude, bool in_radian = true);
    ...
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ GNSSCalibrationParameters {
        ...
        /**
         * @brief When this parameter is enabled (set to true), the calibration process between GNSS and VIO accounts for the uncertainty in
         * the determined translation, thereby facilitating the calibration termination. The maximum allowable uncertainty is controlled by
         * the 'target_translation_uncertainty' parameter.
         */
        ...
        /**
         * @brief This parameter determines whether reinitialization should be performed between GNSS and VIO fusion when a significant
         * disparity is detected between GNSS data and the current fusion data. It becomes particularly crucial during prolonged GNSS signal
         * loss scenarios.
         */
        bool enable_reinitialization = true;
        /**
         * @brief This parameter determines the threshold for GNSS/VIO reinitialization.
         * If the fused position deviates beyond out of the region defined by the product of the GNSS covariance and the
         * gnss_vio_reinit_threshold, a reinitialization will be triggered.
         */
        float gnss_vio_reinit_threshold = 5;
        /**
         * @brief If this parameter is set to true, the fusion algorithm will used a rough VIO / GNSS calibration at first and then refine
         * it. This allow you to quickly get a fused position.
         */
...
namespace sl {
    ...
    \class Mesh
    \ingroup SpatialMapping_group
    \brief Class representing a mesh and containing the geometric (and optionally texture) data of the scene captured by the spatial mapping
    module.

    By default the mesh is defined as a set of chunks.
    \n This way we update only the data that has to be updated avoiding a time consuming remapping process every time a small part of the
    sl::Mesh is updated.
     */
    ...
    public:
        ...
        */
        ...
        false. \return True if the mesh was successfully filtered, otherwise false.
        ...
        \param texture_format : Number of channels desired for the computed texture.\n Default: [sl::MESH_TEXTURE_FORMAT::RGB](\ref
        MESH_TEXTURE_FORMAT). \return True if the mesh was successfully textured, otherwise false.
        ...
        \warning The sl::SpatialMappingParameters.save_texture parameter must be set to true when enabling the spatial mapping to be able to
        apply the textures. \warning The mesh should be filtered before calling this method since \ref filter() will erase the textures.
        ...
        Default: false. \return True if the mesh was successfully loaded, otherwise false.
    ...
    public:
        ...
        /**
        \brief Gets the distance between the input point and the projected point alongside the normal vector onto the plane (the closest
        point on the plane). \param point : Point to project into the plane. \return The Euclidean distance between the input point and the
        projected point.
         */
    ...
    \ingroup SpatialMapping_group
    \brief Class representing a fused point cloud and containing the geometric and color data of the scene captured by the spatial mapping
    module.

    By default the fused point cloud is defined as a set of point cloud chunks.
    \n This way we update only the required data, avoiding a time consuming remapping process every time a small part of the
    sl::FusedPointCloud cloud is changed.
     */
...
#define ZED_SDK_BUILD_ID "106231_f4e0c540"

#define ZED_SDK_VERSION_ATTRIBUTE                                                                            \
private:                                                                                                     \
    uint32_t _zed_sdk_major_version = ZED_SDK_MAJOR_VERSION, _zed_sdk_minor_version = ZED_SDK_MINOR_VERSION, \
             _zed_sdk_patch_version = ZED_SDK_PATCH_VERSION;

/**
 * \ingroup Core_group
 * \brief Returns the ZED SDK version currently installed on the computer.
 * \param[out] major : Major variable to be filled.
 * \param[out] minor : Minor variable to be filled.
 * \param[out] patch : Patch variable to be filled.
...
#define isValidMeasure(v) (std::isfinite(v))
    ...
    \warning You can find the available resolutions for each camera in <a
    href="https://www.stereolabs.com/docs/video/camera-controls#selecting-a-resolution">our documentation</a>.
     */
    enum class RESOLUTION {
        ...
        AUTO,    /**< Select the resolution compatible with the camera: <ul><li>ZED X/X Mini: HD1200</li><li>ZED X Pro/X Pro Mini:
                    HD1536</li><li>other cameras: HD720</li></ul> */
        ///@cond SHOWHIDDEN
        LAST
        ///@endcond
    };
    ...
    bool SL_SDK_EXPORT fromString(const sl::String& resolution_str, RESOLUTION& resolution);
    ...
    \warning All \ref VIDEO_SETTINGS are not supported for all camera models. You can find the supported \ref VIDEO_SETTINGS for each ZED
    camera in our <a href="https://www.stereolabs.com/docs/video/camera-controls#adjusting-camera-settings">documentation</a>.\n\n GAIN and
    EXPOSURE are linked in auto/default mode (see \ref sl::Camera.setCameraSettings()).
     */
    enum class VIDEO_SETTINGS {
        ...
        GAIN, /**< Gain control \n Affected value should be between 0 and 100 for manual control. \note If EXPOSURE is set to -1 (automatic
                 mode), then GAIN will be automatic as well.*/
        EXPOSURE, /**< Exposure control \n Affected value should be between 0 and 100 for manual control.\n The exposition is mapped
                     linearly in a percentage of the following max values.\n Special case for <code>EXPOSURE = 0</code> that corresponds to
                     0.17072ms.\n The conversion to milliseconds depends on the framerate: <ul><li>15fps & <code>EXPOSURE = 100</code>
                     -> 19.97ms</li><li>30fps & <code>EXPOSURE = 100</code> -> 19.97ms</li><li>60fps & <code>EXPOSURE = 100</code>
                     -> 10.84072ms</li><li>100fps & <code>EXPOSURE = 100</code> -> 10.106624ms</li></ul>*/
        AEC_AGC,  /**< Defines if the GAIN and EXPOSURE are in automatic mode or not.\n Setting GAIN or EXPOSURE values will automatically
                     set this value to 0.*/
        AEC_AGC_ROI, /**< Defines the region of interest for automatic exposure/gain computation.\n To be used with overloaded \ref
                        Camera.setCameraSettings(VIDEO_SETTINGS,Rect,sl::SIDE,bool) "setCameraSettings()" / \ref
                        Camera.getCameraSettings(VIDEO_SETTINGS,Rect&,sl::SIDE) "getCameraSettings()" methods.*/
    ...
    enum class DEPTH_MODE {
        ...
        PERFORMANCE,  /**< \deprecated Computation mode optimized for speed.*/
        QUALITY,      /**< \deprecated Computation mode designed for challenging areas with untextured surfaces.*/
        ULTRA,        /**< \deprecated Computation mode that favors edges and sharpness.\n Requires more GPU memory and computation power.*/
    ...
    bool SL_SDK_EXPORT fromString(const String& depthMode_str, DEPTH_MODE& depthMode);
    ...
    enum class MEASURE {
        ...
        DEPTH_U16_MM,    /**< Depth map in millimeter whatever the sl::UNIT defined in sl::InitParameters.coordinate_units.\n Invalid values
                            are set to 0 and depth values are clamped at 65000.\n Each pixel contains 1 unsigned short.\n Type: \ref MAT_TYPE
                            "sl::MAT_TYPE::U16_C1".*/
    ...
    enum class VIEW {
        LEFT,  /**< Left (for stereo or default for monocular camera) BGRA image. Each pixel contains 4 unsigned char (B, G, R, A).\n Type:
                  \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        ...
        CONFIDENCE,    /**< Color rendering of the depth confidence. Each pixel contains 4 unsigned char (B, G, R, A).\n Type: \ref MAT_TYPE
                          "sl::MAT_TYPE::U8_C4" \note Use \ref MEASURE "MEASURE::CONFIDENCE" with \ref Camera.retrieveMeasure() to get
                          confidence values. */
        ...
        DEPTH_RIGHT,   /**< Color rendering of the right depth mapped on right sensor. Each pixel contains 4 unsigned char (B, G, R, A).\n
                          Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" \note Use \ref MEASURE "MEASURE::DEPTH_RIGHT" with \ref
                          Camera.retrieveMeasure() to get depth right values. */
        NORMALS_RIGHT, /**< Color rendering of the normals mapped on right sensor. Each pixel contains 4 unsigned char (B, G, R, A).\n Type:
                          \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" \note Use \ref MEASURE "MEASURE::NORMALS_RIGHT" with \ref
                          Camera.retrieveMeasure() to get normal right values. */
        LEFT_BGRA,     /**< Alias of \ref VIEW "sl::VIEW::LEFT".\n Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        LEFT_BGR,      /**< Left image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        RIGHT_BGRA,    /**< Alias of \ref VIEW "sl::VIEW::RIGHT".\n Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        RIGHT_BGR,     /**< Right image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        LEFT_UNRECTIFIED_BGRA,         /**< Alias of \ref VIEW "sl::VIEW::LEFT_UNRECTIFIED".\n Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        LEFT_UNRECTIFIED_BGR,          /**< Left unrectified image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        RIGHT_UNRECTIFIED_BGRA,        /**< Alias of \ref VIEW "sl::VIEW::RIGHT_UNRECTIFIED".\n Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        RIGHT_UNRECTIFIED_BGR,         /**< Right unrectified image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        SIDE_BY_SIDE_BGRA,             /**< Alias of \ref VIEW "sl::VIEW::SIDE_BY_SIDE".\n Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        SIDE_BY_SIDE_BGR,              /**< Side by side image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        SIDE_BY_SIDE_GRAY,             /**< Side by side image in gray scale: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C1" */
        SIDE_BY_SIDE_UNRECTIFIED_BGRA, /**< Alias of \ref VIEW "sl::VIEW::SIDE_BY_SIDE_UNRECTIFIED".\n Type: \ref MAT_TYPE
                                          "sl::MAT_TYPE::U8_C4" */
        SIDE_BY_SIDE_UNRECTIFIED_BGR,  /**< Side by side unrectified image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        SIDE_BY_SIDE_UNRECTIFIED_GRAY, /**< Side by side unrectified image in gray scale: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C1" */
        DEPTH_BGRA,                    /**< Alias of \ref VIEW "sl::VIEW::DEPTH".\n Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        DEPTH_BGR,                     /**< Depth image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        DEPTH_GRAY,                    /**< Depth image in gray scale: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C1" */
        CONFIDENCE_BGRA,               /**< Alias of \ref VIEW "sl::VIEW::CONFIDENCE".\n Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        CONFIDENCE_BGR,                /**< Confidence image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        CONFIDENCE_GRAY,               /**< Confidence image in gray scale: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C1" */
        NORMALS_BGRA,                  /**< Alias of \ref VIEW "sl::VIEW::NORMALS".\n Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        NORMALS_BGR,                   /**< Normal image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        NORMALS_GRAY,                  /**< Normal image in gray scale: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C1" */
        DEPTH_RIGHT_BGRA,              /**< Alias of \ref VIEW "sl::VIEW::DEPTH_RIGHT".\n Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        DEPTH_RIGHT_BGR,               /**< Depth right image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        DEPTH_RIGHT_GRAY,              /**< Depth right image in gray scale: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C1" */
        NORMALS_RIGHT_BGRA,            /**< Alias of \ref VIEW "sl::VIEW::NORMALS_RIGHT".\n Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C4" */
        NORMALS_RIGHT_BGR,             /**< Normal right image in BGR pixel format: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C3" */
        NORMALS_RIGHT_GRAY,            /**< Normal right image in gray scale: Type: \ref MAT_TYPE "sl::MAT_TYPE::U8_C1" */
    ...
    enum class POSITIONAL_TRACKING_MODE {
        ...
        GEN_2, /**< \deprecated. */
        GEN_3, /**< Fast and accurate, in both exploratory mode and mapped environments.\Note Can be used even if depth_mode is set to \ref
                  DEPTH_MODE::NONE.*/
        ///@cond SHOWHIDDEN
        LAST
        ///@endcond
    ...
    bool SL_SDK_EXPORT fromString(const String& track_mode_str, POSITIONAL_TRACKING_MODE& track_mode);
    ...
    enum class SPATIAL_MAPPING_STATE {
        ...
        FPS_TOO_LOW, /**< The effective FPS is too low to give proper results for spatial mapping.\n Consider using performance parameters
                        (\ref DEPTH_MODE "sl::DEPTH_MODE::PERFORMANCE", \ref SpatialMappingParameters::MAPPING_RESOLUTION
                        "sl::SpatialMappingParameters::MAPPING_RESOLUTION::LOW", low camera resolution (\ref RESOLUTION
                        "sl::RESOLUTION::VGA/SVGA" or \ref RESOLUTION "sl::RESOLUTION::HD720").*/
        ///@cond SHOWHIDDEN
        LAST
        ///@endcond
    };
    ...
    \note LOSSLESS is an improvement of previous lossless compression (used in ZED Explorer), even if size may be bigger, compression time
    is much faster.
     */
    ...
    bool /*@cond SHOWHIDDEN*/ SL_SDK_EXPORT /*@endcond*/
    fromString(const sl::String& svo_compression_str, SVO_COMPRESSION_MODE& svo_compression);
    ...
    struct /*@cond SHOWHIDDEN*/ SL_SDK_EXPORT /*@endcond*/ RecordingStatus {
        ...
        /**
        \brief Number of frames ingested in SVO encoding/writting
         */
        int number_frames_ingested;

        /**
        \brief Number of frames effectively encoded and written. Might be different from the number of frames ingested. The difference will
        show the encoder latency
         */
    ...
    void /*@cond SHOWHIDDEN*/ SL_SDK_EXPORT /*@endcond*/ setEnvironmentVariable(const sl::String& env_var_name, const sl::String& value);

    /**
    \brief Available camera FPS.
    Those values are not available for all cameras/resolutions.
    use the isAvailable() function to check if a specific camera/resolution/fps is available.
    \note The ZED SDK will automatically select the best available FPS for the camera/resolution if AUTO is selected.
    */
    inline const std::vector<int>& getAvailableCameraFPS() {
        static std::vector<int> availables_camera_fps = {15, 30, 60, 100, 120};
        return availables_camera_fps;
    }

    /**
    \brief Test if a specific resolution is available for the specified camera model.
    ...
    */
    bool /*@cond SHOWHIDDEN*/ SL_SDK_EXPORT /*@endcond*/ isAvailable(const sl::RESOLUTION resolution, const sl::MODEL camera_model);

    /**
    \brief Test if a specific resolution/fps combination is available for the specified camera model.
    ...
    */
    bool /*@cond SHOWHIDDEN*/ SL_SDK_EXPORT /*@endcond*/
    isAvailable(const int fps, const sl::RESOLUTION resolution, const sl::MODEL camera_model);

    /**
    \brief Test if the HDR mode can be activated at a specific resolution for the specified camera model.
    \param resolution : The wanted resolution.
    \param camera_model : The wanted camera model.
    \return True if the resolution is available for the camera model, false otherwise.
    */
    bool /*@cond SHOWHIDDEN*/ SL_SDK_EXPORT /*@endcond*/ supportHDR(const sl::RESOLUTION resolution, const sl::MODEL camera_model);
...
namespace sl {
    ...
    This class allows you to select multiple parameters for the sl::Camera such as the selected camera, resolution, depth mode, coordinate
    ...
    public:
        ...
        \n Default: \ref FLIP_MODE "sl::FLIP_MODE::OFF"
        \note From ZED SDK 3.2 a new sl::FLIP_MODE enum was introduced to add the automatic flip mode detection based on the IMU gravity
        ...
        \n A drawback is that calibration parameters will slightly change from one (live) run to another, which can be an issue for
        repeatability. \n If set to true, self-calibration will be disabled and calibration parameters won't be optimized, raw calibration
        parameters from the configuration file will be used. \n Default: false \note In most situations, self calibration should remain
        enabled. \note You can also trigger the self-calibration at anytime after sl::Camera::open() by calling
        sl::Camera::updateSelfCalibration(), even if this parameter is set to true.
         */
        ...
        \n This parameter allows you to enable \ref MEASURE "sl::MEASURE::DEPTH_RIGHT" and other \ref MEASURE "sl::MEASURE::XXX_RIGHT" at
        the cost of additional computation time. \n For example, mixed reality pass-through applications require one depth map per eye, so
        ...
        \n Default: \ref DEPTH_MODE "sl::DEPTH_MODE::NEURAL_LIGHT" for jetson devices else \ref DEPTH_MODE "sl::DEPTH_MODE::NEURAL"
         */
        ...
        \n In stereovision (the depth technology used by the camera), looking for closer depth values can have a slight impact on
        performance and memory consumption. \n On most modern GPUs, performance impact will be low. However, the impact of memory footprint
        will be visible. \n In cases of limited computation power, increasing this value can provide better performance. \n Default: -1
        (corresponding values are available <a href="https://www.stereolabs.com/docs/depth-sensing/depth-settings#depth-range">here</a>)
        ...
        \n However, when running several applications, or using several cameras at the same time, splitting the load over available GPUs can
        ...
        \n When developing an application, enabling verbose (<code>\ref sdk_verbose >= 1</code>) mode can help you understand the current
        ZED SDK behavior. \n However, this might not be desirable in a shipped version. \n Default: 1 (verbose message enabled) \note The
        verbose messages can also be exported into a log file. \note See \ref sdk_verbose_log_file for more.
         */
        int sdk_verbose;
        ...
        \note This parameter can be particularly useful for creating a log system, and with Unreal or Unity applications that don't provide
        a standard console output. \warning The log file won't be cleared after successive executions of the application. \warning This
        means that it can grow indefinitely if not cleared.
         */
        ...
        If your application uses another CUDA-capable library, giving its CUDA context to the ZED SDK can be useful when sharing GPU
        memories. \n This parameter allows you to set the CUDA context to be used by the ZED SDK. \n Leaving this parameter empty asks the
        SDK to create its own context. \n Default: (empty)

        \note When creating you own CUDA context, you have to define the device you will use. Do not forget to also specify it on \ref
        sdk_gpu_id. \note <b>On Jetson</b>, you have to set the flag CU_CTX_SCHED_YIELD, during CUDA context creation. \note You can also
        let the SDK create its own context, and use sl::Camera::getCUDAContext() to use it. \note If you create your own CUDA context, you
        must ensure that it is destroyed after all SDK objects (sl::Camera, sl::Fusion) are destroyed.
         */
        ...
        InitParameters init_params; // Set initial parameters
        init_params.sdk_verbose = 1; // Enable verbose mode
        init_params.input.setFromStream("192.168.1.42"); // Selects the IP address of the streaming camera. A second optional parameter is
        available for port selection. \endcode

        \note Available cameras and their id/serial number can be listed using sl::Camera::getDeviceList() and
        sl::Camera::getStreamingDeviceList(). \note Each sl::Camera will create its own memory (CPU and GPU), therefore the number of
        cameras used at the same time can be limited by the configuration of your computer (GPU/CPU memory and capabilities).
        ...
        \note An automatic download of the settings file (through <b>ZED Explorer</b> or the installer) will still download the files on the
        default path.

        \code
        InitParameters init_params; // Set initial parameters
        std::string home = getenv("HOME"); // Get /home/user as string using getenv()
        std::string path = home + "/Documents/settings/"; // Assuming /home/<user>/Documents/settings/SNXXXX.conf exists. Otherwise, it will
        be searched in /usr/local/zed/settings/ init_params.optional_settings_path = sl::String(path.c_str()); \endcode
         */
        String optional_settings_path;

        /**
        \brief If set, the specific file will be loaded to overwrite the default factory calibration file.

        The file must be in a XML/YAML/JSON formatting provided by OpenCV.
        You can find a sample <a href="https://www.stereolabs.com/docs/opencv/calibration#calibration-1">here</a> to generate your own
        calibration file and to have more information about the required format.
        ...
        \note If set to false, the ZED SDK will try to <b>open and use</b> the IMU (second USB device on USB2.0) and will open the camera
        successfully even if the sensors failed to open.
        ...
        \note This parameter should be used when the IMU data must be available, such as object detection module or when the gravity is
        needed.
        ...
        This can be useful to get a known constant fixed rate or limit the computation load while keeping a short exposure time by setting a
        high camera capture framerate. \n The value should be inferior to the sl::InitParameters.camera_fps and strictly positive. \note  It
        has no effect when reading an SVO file.

        This is an upper limit and won't make a difference if the computation is slower than the desired compute capping FPS.
        \note Internally the sl::Camera::grab() method always tries to get the latest available image while respecting the desired FPS as
        much as possible.
         */
        float grab_compute_capping_fps;

        /**
         * \brief If set to true will camera image retrieve at a framerate different from \ref Camera::grab() application framerate.
         * This is useful for recording SVO or sending camera stream at different rate than application.
         *
         */
        ...
        This will perform additional verification on the image to identify corrupted data. This verification is done in the
        sl::Camera.grab() method and requires some computations. \n If an issue is found, the sl::Camera.grab() method will output a warning
        as [sl::ERROR_CODE::CORRUPTED_FRAME](\ref ERROR_CODE). \n This version doesn't detect frame tearing currently. \n Default: false
        (disabled)
         */
         ...
         *
         * This will override the default (0,0) and instead of outputting native image size sl::Mat, the ZED SDK will take this size as
        default.
         * A custom lower size can also be used at runtime, but not bigger. This is used for internal optimization of compute and memory
        allocations
         *
         ...
         */
        InitParameters(
            RESOLUTION camera_resolution_ = RESOLUTION::AUTO,
            int camera_fps_ = 0,
            bool svo_real_time_mode_ = false,
#ifdef _SL_JETSON_
            DEPTH_MODE depth_mode_ = DEPTH_MODE::NEURAL_LIGHT,
#else
    ...
    public:
        ...
        \warning Enabling this will override the confidence values \ref confidence_threshold and \ref texture_confidence_threshold as well
        as \ref remove_saturated_areas.
         */
        ...
        \n Decreasing this value will remove depth data from both objects edges and low textured areas, to keep only confident depth
        estimation data. \n Default: 95 \note Pixels with a value close to 100 are not to be trusted. Accurate depth pixels tends to be
    ...
    public:
        ...
        \note The camera frame (which defines the reference frame for the camera) is by default positioned at the world frame when tracking
        is started.
         */
        ...
        Default: (empty)
        \note Loading an area file will start a search phase, during which the camera will try to position itself in the previously learned
        area.

        \warning The area file describes a specific location. If you are using an area file describing a different location, the tracking
        function will continuously search for a position and may not find a correct one. \warning The '.area' file can only be used with the
        same depth mode (sl::DEPTH_MODE) as the one used during area recording.
         */
         ...
         */
        bool enable_localization_only = false;

        /**
         * \brief Whether to enable the 2D ground mode.
         */
        bool enable_2d_ground_mode = false;
        ...
        PositionalTrackingParameters(
            Transform init_position_ = Transform(),
    ...
    public:
        ...
        SpatialMappingParameters(
            MAPPING_RESOLUTION resolution = MAPPING_RESOLUTION::MEDIUM,
        ...
        \param mapping_resolution: The desired [MAPPING_RESOLUTION](\ref SpatialMappingParameters::MAPPING_RESOLUTION). Default:
        [MAPPING_RESOLUTION::MEDIUM](\ref SpatialMappingParameters::MAPPING_RESOLUTION) \return The value of \b mapping_resolution in
        meters.
         */
        ...
        \param mapping_resolution: The desired [MAPPING_RESOLUTION](\ref SpatialMappingParameters::MAPPING_RESOLUTION). Default:
        [MAPPING_RESOLUTION::MEDIUM](\ref SpatialMappingParameters::MAPPING_RESOLUTION)
         */
        ...
        \param mapping_range: The desired [MAPPING_RANGE](\ref SpatialMappingParameters::MAPPING_RANGE). Default:
        [MAPPING_RANGE::MEDIUM](\ref SpatialMappingParameters::MAPPING_RANGE) \return The value of \b mapping_range in meters.
         */
        ...
        \param mapping_range: The desired [MAPPING_RANGE](\ref SpatialMappingParameters::MAPPING_RANGE). Default:
        [MAPPING_RANGE::MEDIUM](\ref SpatialMappingParameters::MAPPING_RANGE)
         */
        ...
        \note This option is only available for [sl::SpatialMappingParameters::SPATIAL_MAP_TYPE::MESH](\ref
        SpatialMappingParameters::SPATIAL_MAP_TYPE).
         */
        ...
        \n Default: 0 (this will define the stability counter based on the mesh resolution, the higher the resolution, the higher the
        stability counter)
         */
        int stability_counter = 0;

        /**
         * @brief Control the disparity noise (standard deviation) in px. set a very small value (<0.1) if the depth map of the scene is
         * accurate. set a big value (>0.5) if the depth map is noisy.
         */
        float disparity_std = 0.3;

        /**
        \brief Adjust the weighting factor for the current depth during the integration process.
         By default, the value is set to 1, which results in the complete integration and fusion of the current depth with the previously
        integrated depth. Setting it to 0 discards all previous data and solely integrates the current depth.
         */
        float decay = 1;

        /**
         \brief This parameter enables the forgetting of the previous map to limit memory and drift issues. It enables a local spatial
        mapping that only keeps a mapped scene around the current camera position. The distance threshold is set to be equal to 1.5 x the
        range of the spatial mapping.
         */
        bool enable_forget_past = false;
    ...
    struct /*@cond SHOWHIDDEN*/ SL_SDK_EXPORT /*@endcond*/ StreamingParameters {
        ...
        \note The GOP size determines the maximum distance between IDR/I-frames. Very high GOP size will result in slightly more efficient
        compression, especially on static scenes. But latency will increase. \note Maximum value: 256
         */
        int gop_size = -1;
         ...
         */
        StreamingParameters(
            STREAMING_CODEC codec_ = STREAMING_CODEC::H265,
    ...
    struct /*@cond SHOWHIDDEN*/ SL_SDK_EXPORT /*@endcond*/ RecordingParameters {
        ...
        Default: 0 (camera framerate will be taken)
        \warning This framerate must be below or equal to the camera framerate and camera framerate must be a multiple of the target
        framerate. \warning It means that it must respect <code> camera_framerate%target_framerate == 0</code>. \warning Allowed framerates
        are 15,30, 60 or 100 if possible. \warning Any other values will be discarded and camera FPS will be taken.
         */
        unsigned int target_framerate = 0;
        ...
        \note This saves a encoding session and can be especially useful on NVIDIA Geforce cards where the number of encoding session is
         ...
         */
        RecordingParameters(
            String video_filename_ = "myRecording.svo2",
    ...
    \brief This class serves as the primary interface between the camera and the various features provided by the SDK.
     ...
     It enables seamless integration and access to a wide array of capabilities, including video streaming, depth sensing, object tracking,
     ...
     int main(int argc, char **argv) {
             ...
             while (i < 50) {
                     ...
                     if (zed.grab() == ERROR_CODE::SUCCESS) { // A new image is available if grab() returns SUCCESS
                             ...
                             std::cout << "Image " << i << " center pixel B: " << (int)centerBGRA[0] << " G: " << (int)centerBGRA[1] << " R:
    " << (int)centerBGRA[2] << std::endl;
    ...
    public:
        ...
        \return An error code giving information about the internal process. If \ref ERROR_CODE "ERROR_CODE::SUCCESS" is returned, the
        camera is ready to use. Every other code indicates an error and the program should be stopped.
        ...
        If \ref open() has been called, this method will close the connection to the camera (or the SVO file) and free the corresponding
        memory.

        If \ref open() wasn't called or failed, this method won't have any effects.

        \note If an asynchronous task is running within the \ref Camera object, like \ref saveAreaMap(), this method will wait for its
        completion. \note To apply a new \ref InitParameters, you will need to close the camera first and then open it again with the new
        ...
        \note If no new frames is available until timeout is reached, read() will return \ref ERROR_CODE "ERROR_CODE::CAMERA_NOT_DETECTED"
        since the camera has probably been disconnected. \note Returned errors can be displayed using toString().
        ...
        /**
        \brief This method will call \ref read if hasn't been called then compute the \ref retrieveMeasure() "measurements" based on the
        \ref RuntimeParameters provided (depth, point cloud, tracking, etc.)
        ...
        \n The exact duration will mostly depend on the following parameters:
           ...
           - \ref RuntimeParameters.enable_depth : Avoiding the depth computation must be faster. However, it is required by most SDK
        features (tracking, spatial mapping, plane estimation, etc.)
           - \ref InitParameters.depth_mode : \ref DEPTH_MODE "DEPTH_MODE::PERFORMANCE" will run faster than \ref DEPTH_MODE
        "DEPTH_MODE::ULTRA".
        ...
        \note If no new frames is available until timeout is reached, grab() will return \ref ERROR_CODE "ERROR_CODE::CAMERA_NOT_DETECTED"
        since the camera has probably been disconnected.
        ...
        To ensure accurate calibration, it is possible to specify a custom resolution as a parameter when obtaining scaled information, as
        calibration parameters are resolution-dependent. \n When reading an SVO file, the parameters will correspond to the camera used for
        recording.

        \param image_size : You can specify a size different from the default image size to get the scaled camera information. Default =
        (0,0) meaning original image size (given by \ref CameraConfiguration.resolution
        "getCameraInformation().camera_configuration.resolution"). \return \ref CameraInformation containing the calibration parameters of
        the ZED, as well as serial number and firmware version.

        \note The \ref CameraConfiguration "CameraInformation.camera_configuration" will contain two types of calibration parameters:
        - \ref CameraConfiguration.calibration_parameters "camera_configuration.calibration_parameters": it contains the calibration for the
        <b>rectified</b> images. Rectified images are images that would come from perfect stereo camera (exact same camera, perfectly
        matched). Therefore, the camera matrix will be identical for left and right camera, and the distortion/rotation/translation matrix
        will be null (except for Tx, which is the exact distance between both eyes).
        - \ref CameraConfiguration.calibration_parameters_raw "camera_configuration.calibration_parameters_raw": it contains the original
        calibration before rectification. Therefore it should be identical or very close to the calibration file SNXXXX.conf where XXXX is
        the serial number of the camera.

        \warning The returned parameters might vary between two execution due to the \ref InitParameters.camera_disable_self_calib
        "self-calibration" being run in the \ref open() method. \note The calibration file SNXXXX.conf can be found in:
        - <b>Windows:</b> <i>C:/ProgramData/Stereolabs/settings/</i>
        - <b>Linux:</b> <i>/usr/local/zed/settings/</i>
         */
        CameraInformation getCameraInformation(Resolution image_size = Resolution(0, 0)) const;
        ...
        \warning New values will then be available in \ref getCameraInformation(), be sure to get them to still have consistent 2D <-> 3D
        conversion.
         */
        ...
        \note If you're looking for the opposite mechanism, where an existing CUDA context is given to the \ref Camera, please check \ref
        InitParameters.sdk_cuda_ctx \return The CUDA context used for GPU calls.
         */
        ...
        \n As an example, \ref VIEW "VIEW::DEPTH" can be used to get a gray-scale version of the depth map, but the actual depth values can
        be retrieved using \ref retrieveMeasure(). \n \n <b>Pixels</b> \n Most VIEW modes output image with 4 channels as BGRA (Blue, Green,
        Red, Alpha), for more information see enum \ref VIEW \n \n <b>Memory</b> \n By default, images are copied from GPU memory to CPU
        memory (RAM) when this function is called. \n If your application can use GPU images, using the <b>type</b> parameter can increase
        performance by avoiding this copy. \n If the provided \ref Mat object is already allocated  and matches the requested image format,
        memory won't be re-allocated. \n \n <b>Image size</b> \n By default, images are returned in the resolution provided by \ref
        Resolution "getCameraInformation().camera_configuration.resolution". \n However, you can request custom resolutions. For example,
        requesting a smaller image can help you speed up your application.

        \warning A sl::Mat resolution higher than the camera resolution <b>cannot</b> be requested.

        \param mat  : The \ref sl::Mat to store the image. The method will create the Mat if necessary at the proper resolution. If already
        created, it will just update its data (CPU or GPU depending on the MEM type).
        ...
        \param image_size : If specified, define the resolution of the output sl::Mat. If set to \ref Resolution "Resolution(0,0)", the
        camera resolution will be taken. Default: (0,0). \param stream : If passed, the CUDA stream to use for GPU calls.

        \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if the method succeeded.
        \return \ref ERROR_CODE "ERROR_CODE::INVALID_FUNCTION_PARAMETERS" if the view mode requires a module not enabled (\ref VIEW
        "VIEW::DEPTH" with \ref DEPTH_MODE "DEPTH_MODE::NONE" for example). \return \ref ERROR_CODE "ERROR_CODE::INVALID_RESOLUTION" if the
        resolution is higher than one provided by \ref Resolution "getCameraInformation().camera_configuration.resolution". \return \ref
        ERROR_CODE "ERROR_CODE::FAILURE" if another error occurred.
        ...
        while (true) {
                ...
                if (zed.grab() == ERROR_CODE::SUCCESS) { // A new image is available if grab() returns SUCCESS
                        ...
                        std::cout << "left image color B: " << (int)leftCenter[0] << " G: " << (int)leftCenter[1] << " R: " <<
        (int)leftCenter[2] << std::endl;
                }
        }
        \endcode
         */
        ...
        \return \ref ERROR_CODE to indicate if the method was successful. If successful, setting will be filled with the corresponding
        value.
        ...
        /**
        \brief Fills the current values of the requested \ref VIDEO_SETTINGS "settings" for \ref VIDEO_SETTINGS that supports two values
        (min/max).
        ...
        \note It will return \ref ERROR_CODE "ERROR_CODE::INVALID_FUNCTION_CALL" or \ref ERROR_CODE
        "ERROR_CODE::INVALID_FUNCTION_PARAMETERS" otherwise.
         */
        ...
        \warning Setting \ref VIDEO_SETTINGS "VIDEO_SETTINGS::EXPOSURE" or \ref VIDEO_SETTINGS "VIDEO_SETTINGS::GAIN" to default will
        automatically sets the other to default.
        ...
        \warning If \ref VIDEO_SETTINGS settings is not supported or min >= max, it will return \ref ERROR_CODE
        ...
        \param settings : Must be set at a valid \ref VIDEO_SETTINGS that accepts a min/max range and available for the current camera
        model. \param min : The minimum value that can be reached to be filled. \param max : The maximum value that can be reached to be
        filled. \return \ref ERROR_CODE to indicate if the method was successful.
         */
        ...
        \warning The returned framerate (number of images grabbed per second) can be lower than \ref InitParameters.camera_fps if the \ref
        grab() function runs slower than the image stream or is called too often.
        ...
        - When requesting the \ref TIME_REFERENCE "TIME_REFERENCE::IMAGE" timestamp, the UNIX nanosecond timestamp of the latest \ref grab()
        "grabbed" image will be returned. \n This value corresponds to the time at which the entire image was available in the PC memory. As
        such, it ignores the communication time that corresponds to 1 or 2 frame-time based on the fps (ex: 16.6ms to 33ms at 60fps).
        ...
        \n This can happen if two frames were extracted from the camera when grab() is called. The older frame will be dropped so as to
        always use the latest (which minimizes latency).
        ...
        This method allows you to move around within a played-back SVO file. After calling, the next call to \ref grab() will read the
        ...
        \warning Using this function is not a standard behavior as it creates a jump in time, backward or forward (which can not happen in
        live conditions). This function will then reset many modules such as positional tracking or spatial mapping.
        ...
        \n
        \n <b>Measure size</b>
        \n By default, measures are returned at the optimal resolution for speed and quality.
        \n However, custom resolutions can be requested. For example, requesting a higher measure for specific needs, or a lower resolution
        for even faster data transfer

        \warning A sl::Mat resolution higher than the camera resolution <b>cannot</b> be requested.

        \param mat  : The \ref Mat to store the measure. The method will create the Mat if necessary at the proper resolution. If already
        created, it will just update its data (CPU or GPU depending on the MEM type). \param measure : Defines the measure you want (see
        \ref MEASURE). Default: \ref MEASURE "MEASURE::DEPTH". \param type : Defines on which memory the image should be allocated. Default:
        \ref MEM "MEM::CPU". \param image_size : If specified, define the resolution of the output sl::Mat. If set to \ref Resolution
        "Resolution(0,0)", the camera resolution or InitParameters::maximum_working_resolution will be taken, whichever is the smallest.
        Default: (-1,-1).
         * The default (-1,-1) automatically choose the best size for a given DEPTH_MODE
         * To override this new default value, and fallback on the older (0,0) based on the camera image size, the environment variable
        "ZED_SDK_DISABLE_AUTO_RETRIEVE_RESOLUTION" can be set to 1
         * For instance on linux, in a terminal before running your program, call "export ZED_SDK_DISABLE_AUTO_RETRIEVE_RESOLUTION=1", or
        call the function \ref sl::setEnvironmentVariable("ZED_SDK_DISABLE_AUTO_RETRIEVE_RESOLUTION", "1") at the beginning of the code
        \param stream : If passed, the CUDA stream to use for GPU calls.
        \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if the method succeeded.
        \return \ref ERROR_CODE "ERROR_CODE::INVALID_FUNCTION_PARAMETERS" if the view mode requires a module not enabled (\ref VIEW
        "VIEW::DEPTH" with \ref DEPTH_MODE "DEPTH_MODE::NONE" for example). \return \ref ERROR_CODE "ERROR_CODE::INVALID_RESOLUTION" if the
        resolution is higher than one provided by \ref Resolution "getCameraInformation().camera_configuration.resolution". \return \ref
        ...
        \note As this function retrieves the measures computed by the \ref grab() function, This function should be called after a grab()
        call that returns \ref ERROR_CODE "ERROR_CODE::SUCCESS".
        ...
        while (true) {
                if (zed.grab() == ERROR_CODE::SUCCESS) { // Grab an image
                        ...
                        sl::float4 pcValue;
                        pointCloud.getValue<sl::float4>(x, y, &pcValue); // each point cloud pixel contains 4 floats, so we are using a
        sl::float4 if (std::isnormal(pcValue.z)) { std::cout << "Point cloud coordinates at center: X=" << pcValue.x << ", Y=" << pcValue.y
        << ", Z=" << pcValue.z << std::endl; unsigned char color[sizeof(float)]; memcpy(color, &pcValue[3], sizeof(float)); std::cout <<
        "Point cloud color at center: B=" << (int)color[0] << ", G=" << (int)color[1] << ", R=" << (int)color[2] << std::endl;
                        }
                }
        }
        \endcode
        ...
        \param roi_mask: The \ref Mat defining the requested region of interest, pixels lower than 127 will be discarded from all modules:
        depth, positional tracking, etc. If empty, set all pixels as valid. The mask can be either at lower or higher resolution than the
        current images. \param module: Apply the ROI to a list of SDK module, all by default \return An \ref ERROR_CODE if something went
        ...
        \note This module is expecting a static portion, typically a fairly close vehicle hood at the bottom of the image.
         ...
         This module work asynchronously, the status can be obtained using \ref getRegionOfInterestAutoDetectionStatus(), the result is
        either auto applied, or can be retrieve using \ref getRegionOfInterest function.
        ...
        \param[out] min : Minimum depth detected (in selected sl::UNIT).
        \param[out] max : Maximum depth detected (in selected sl::UNIT).
        ...
        \param tracking_parameters : A structure containing all the specific parameters for the positional tracking. Default: a preset of
        \ref PositionalTrackingParameters. \return \ref ERROR_CODE "ERROR_CODE::FAILURE" if the \ref
        PositionalTrackingParameters.area_file_path file wasn't found, \ref ERROR_CODE "ERROR_CODE::SUCCESS" otherwise. \warning The
        positional tracking feature benefits from a high framerate. We found HD720@60fps to be the best compromise between image quality and
        framerate.
        ...
        int main(int argc, char **argv) {
                ...
                while (true) {
                        if (zed.grab() == ERROR_CODE::SUCCESS) { // Grab an image and computes the tracking
                                ...
                                std::cout << "Camera position: X=" << cameraPose.getTranslation().x << " Y=" <<
        cameraPose.getTranslation().y << " Z=" << cameraPose.getTranslation().z << std::endl;
                        }
                }
        ...
        - Using \ref REFERENCE_FRAME "REFERENCE_FRAME::WORLD", the returned pose relates to the initial position of the camera (\ref
        PositionalTrackingParameters.initial_world_transform ).
        - Using \ref REFERENCE_FRAME "REFERENCE_FRAME::CAMERA", the returned pose relates to the previous position of the camera.

        If the tracking has been initialized with \ref PositionalTrackingParameters.enable_area_memory to true (default), this method can
        return \ref POSITIONAL_TRACKING_STATE "POSITIONAL_TRACKING_STATE::SEARCHING". \n This means that the tracking lost its link to the
        initial referential and is currently trying to relocate the camera. However, it will keep on providing position estimations.

        \param[out] camera_pose : The pose containing the position of the camera and other information (timestamp, confidence).
        \param[in] reference_frame : Defines the reference from which you want the pose to be expressed. Default: \ref REFERENCE_FRAME
        "REFERENCE_FRAME::WORLD". \return The current \ref POSITIONAL_TRACKING_STATE "state" of the tracking process.
        ...
        while (true) {
                if (zed.grab() == ERROR_CODE::SUCCESS) { // Grab an image and computes the tracking
                        Pose cameraPose;
                        zed.getPosition(cameraPose, REFERENCE_FRAME::WORLD);
                        std::cout << "Camera position: X=" << cameraPose.getTranslation().x << " Y=" << cameraPose.getTranslation().y << "
        Z=" << cameraPose.getTranslation().z << std::endl; std::cout << "Camera Euler rotation: X=" << cameraPose.getEulerAngles().x << "
        Y=" << cameraPose.getEulerAngles().y << " Z=" << cameraPose.getEulerAngles().z << std::endl; std::cout << "Camera Rodrigues
        rotation: X=" << cameraPose.getRotationVector().x << " Y=" << cameraPose.getRotationVector().y << " Z=" <<
        cameraPose.getRotationVector().z << std::endl; std::cout << "Camera quaternion orientation: X=" << cameraPose.getOrientation().x <<
        " Y=" << cameraPose.getOrientation().y << " Z=" << cameraPose.getOrientation().z << " W=" << cameraPose.getOrientation().w <<
         ...
         * @param landmarks Dictionnary of presents landmarks. The key is the unique ID of the landmark and the value is the landmark
         * itself.
         * @return ERROR_CODE that indicate if the function succeed or not.
         */
        sl::ERROR_CODE getPositionalTrackingLandmarks(std::map<uint64_t, sl::Landmark>& landmarks);

        /**
         * @brief Get the feature tracked by the positional tracking in the current image.
         * @param current_2d_landmarks A vector containing the coordinates of the feature being tracked.
         * @return ERROR_CODE that indicate if the function succeed or not.
         */
        sl::ERROR_CODE getPositionalTrackingLandmarks2D(std::vector<sl::Landmark2D>& current_2d_landmarks);
        ...
        If the tracking has been initialized with \ref PositionalTrackingParameters.enable_area_memory to true (default), the method allows
        you to export the spatial memory. \n Reloading the exported file in a future session with \ref
        PositionalTrackingParameters.area_file_path initializes the tracking within the same referential. \n This method is asynchronous,
        and only triggers the file generation. You can use \ref getAreaExportState() to get the export state. The positional tracking keeps
        running while exporting.

        \param area_file_path : Path of an '.area' file to save the spatial memory database in.
        \return \ref ERROR_CODE "ERROR_CODE::FAILURE" if the <b>area_file_path</b> file wasn't found, \ref ERROR_CODE "ERROR_CODE::SUCCESS"
        otherwise. \see getAreaExportState()

        \note This method is asynchronous because the generated data can be heavy, be sure to loop over the  \ref getAreaExportState()
        method with a waiting time. \warning If the camera wasn't moved during the tracking session, or not enough, the spatial memory won't
        be usable and the file won't be exported. \warning The \ref getAreaExportState() method will return \ref AREA_EXPORTING_STATE
        "AREA_EXPORTING_STATE::FILE_EMPTY". \warning A few meters (~3m) of translation or a full rotation should be enough to get usable
        spatial memory. \warning However, as it should be used for relocation purposes, visiting a significant portion of the environment is
        recommended before exporting.
        ...
        \note Please note that this method is not meant to be used in parallel of the \ref grab() method.
         */
        ...
        The positional tracking is immediately stopped. If a file path is given, \ref saveAreaMap() will be called asynchronously. See \ref
        getAreaExportState() to get the exportation state. \n If the tracking has been enabled, this function will automatically be called
        by \ref close() .
        ...
        \note The '.area' database depends on the depth mode and confidence threshold chosen during the recording. The same mode must be
        used to reload the database.
         */
         ...
         */
        PositionalTrackingParameters getPositionalTrackingParameters() const;
        ...
        - Calling \ref getSensorsData with \ref TIME_REFERENCE "TIME_REFERENCE::CURRENT" gives you the latest sensors data received. Getting
        all the data requires to call this method at high frame rate in a thread.
        - Calling \ref getSensorsData with \ref TIME_REFERENCE "TIME_REFERENCE::IMAGE" gives you the sensors data at the time of the latest
        image \ref grab() "grabbed". \n \n \ref SensorsData object contains the previous \ref SensorsData::IMUData structure that was used
        in ZED SDK v2.X: \n \n For IMU data, the values are provided in 2 ways: <ul> <li><b>Time-fused</b> pose estimation that can be
        accessed using: <ul><li>\ref SensorsData::IMUData.pose "data.imu.pose"</li></ul>
                </li>
                <li><b>Raw values</b> from the IMU sensor:
                        <ul>
                                <li>\ref SensorsData::IMUData.angular_velocity "data.imu.angular_velocity", corresponding to the
        gyroscope</li> <li>\ref SensorsData::IMUData.linear_acceleration "data.imu.linear_acceleration", corresponding to the
        accelerometer</li>
        ...
        \param[out] data : The SensorsData variable to store the data.
        \param[in] reference_time: Defines the reference from which you want the data to be expressed.
        ...
        /**
        \brief Retrieves all SensorsData associated to most recent grabbed frame in the specified \ref COORDINATE_SYSTEM of InitParameters.
        ...
        \param[out] data : The SensorsData vector to store the data.
        \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if sensors data have been extracted.
        \return \ref ERROR_CODE "ERROR_CODE::SENSORS_NOT_AVAILABLE" if the camera model is a \ref MODEL "MODEL::ZED".
        \return \ref ERROR_CODE "ERROR_CODE::MOTION_SENSORS_REQUIRED" if the camera model is correct but the sensors module is not opened.
        \return \ref ERROR_CODE "ERROR_CODE::INVALID_FUNCTION_PARAMETERS" if the <b>reference_time</b> is not valid. See Warning.
        ...
        \code
        if (zed.grab() == ERROR_CODE::SUCCESS) {
            std::vector<SensorsData> sensors_data;
            if (zed.getSensorsDataBatch(sensors_data) == ERROR_CODE::SUCCESS) {
                    for (const auto& sensor_data : sensors_data) {
                            std::cout << " - IMU:\n";
        ...
        \endcode
         */
        ERROR_CODE getSensorsDataBatch(std::vector<SensorsData>& data);
        ...
        \note This method is only effective if the camera has a model other than a \ref MODEL "MODEL::ZED", which does not contains internal
        sensors. \warning It needs to be called before the \ref grab() method. \param transform to be ingested into IMU fusion. Note that
        only the rotation is used. \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if the transform has been passed, \ref ERROR_CODE
        "ERROR_CODE::INVALID_FUNCTION_CALL" otherwise (e.g. when used with a ZED camera which doesn't have IMU data).
         */
        ...
        \n The resulting output can be a \ref Mesh or a \ref FusedPointCloud. It can be be obtained by calling \ref extractWholeSpatialMap()
        or \ref retrieveSpatialMapAsync(). Note that \ref retrieveSpatialMapAsync() should be called after \ref requestSpatialMapAsync().

        \param spatial_mapping_parameters : A structure containing all the specific parameters for the spatial mapping.
        \n Default: a balanced parameter preset between geometric fidelity and output file size. For more information, see the \ref
        SpatialMappingParameters documentation. \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if everything went fine, \ref ERROR_CODE
        "ERROR_CODE::FAILURE" otherwise.

        \warning The tracking (\ref enablePositionalTracking() ) and the depth (\ref RuntimeParameters.enable_depth ) needs to be enabled to
        use the spatial mapping. \warning The performance greatly depends on the <b>spatial_mapping_parameters</b>. \warning Lower
        SpatialMappingParameters.range_meter and SpatialMappingParameters.resolution_meter for higher performance. If the mapping framerate
        is too slow in live mode, consider using an SVO file, or choose a lower mesh resolution.

        \note This feature uses host memory (RAM) to store the 3D map. The maximum amount of available memory allowed can be tweaked using
        the SpatialMappingParameters. \n Exceeding the maximum memory allowed immediately stops the mapping.
        ...
        int main(int argc, char **argv) {
                ...
                init_params.coordinate_system = COORDINATE_SYSTEM::RIGHT_HANDED_Y_UP; // Use a right-handed Y-up coordinate system (The
        OpenGL one) init_params.coordinate_units = UNIT::METER; // Set units in meters
                ...
                while (i < 500) {
                        ...
                        if (zed.grab() == ERROR_CODE::SUCCESS) {
                                ...
                                std::cout << "Images captured: " << i << " / 500  ||  Spatial mapping state: " << mapping_state <<
        std::endl; i++;
                        }
                }
                std::cout << std::endl;
        ...
        The spatial map generation can take a long time depending on the mapping resolution and covered area. This function will trigger the
        generation of a mesh without blocking the program. \n You can get info about the current generation using \ref
        getSpatialMapRequestStatusAsync(), and retrieve the mesh using \ref retrieveSpatialMapAsync() .

        \note Only one mesh can be generated at a time. If the previous mesh generation is not over, new calls of the function will be
        ignored.
        ...
        \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if the mesh is ready and not yet retrieved, otherwise \ref ERROR_CODE
        "ERROR_CODE::FAILURE".
        ...
        /**
        \brief Retrieves the current generated spatial map only if \ref SpatialMappingParameters::map_type was set as \ref
        SpatialMappingParameters::SPATIAL_MAP_TYPE "MESH".
        ...
        \param[out] mesh : The mesh to be filled with the generated spatial map.
        ...
        \warning If the SpatialMappingParameters::map_type has not been setup as \ref SpatialMappingParameters::SPATIAL_MAP_TYPE "MESH", the
        ...
        \n The fused point cloud will only be available when \ref getSpatialMapRequestStatusAsync() returns \ref ERROR_CODE
        "ERROR_CODE::SUCCESS".

        \param[out] fpc : The fused point cloud to be filled with the generated spatial map.
        \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if the mesh is retrieved, otherwise \ref ERROR_CODE "ERROR_CODE::FAILURE".

        \note This method only updates the necessary chunks and adds the new ones in order to improve update speed.
        \warning You should not modify the fused point cloud between two calls of this method, otherwise it can lead to a corrupted fused
        point cloud. \warning If the SpatialMappingParameters::map_type has not been setup as \ref
        SpatialMappingParameters::SPATIAL_MAP_TYPE "FUSED_POINT_CLOUD", the object will be empty.
        ...
        // -----------------------------------------------------------------
        /**
        \brief Extract the current spatial map from the spatial mapping process only if \ref SpatialMappingParameters::map_type was set as
        \ref SpatialMappingParameters::SPATIAL_MAP_TYPE "MESH".
        ...
        \n The extraction can be long, calling this method in the grab loop will block the depth and tracking computation giving bad
        results.
        ...
        /**
        \brief Extract the current spatial map from the spatial mapping process only if \ref SpatialMappingParameters::map_type was set as
        \ref SpatialMappingParameters::SPATIAL_MAP_TYPE "FUSED_POINT_CLOUD".

        If the object to be filled already contains a previous version of the fused point cloud, only changes will be updated, optimizing
        performance.

        \param[out] fpc : The fused point cloud to be filled with the generated spatial map.
        \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if the fused point cloud is filled and available, otherwise \ref ERROR_CODE
        "ERROR_CODE::FAILURE".

        \warning This is a blocking method. You should either call it in a thread or at the end of the mapping process.
        \n The extraction can be long, calling this method in the grab loop will block the depth and tracking computation giving bad
        results. \warning If the SpatialMappingParameters::map_type has not been setup as \ref SpatialMappingParameters::SPATIAL_MAP_TYPE
        "FUSED_POINT_CLOUD", the object will be empty.
        ...
        As spatial mapping runs asynchronously, using this method can pause its computation to free some processing power, and resume it
        ...
        \note This method frees the memory allocated for the spatial mapping, consequently, meshes and fused point clouds cannot be
        retrieved after this call.
         */
         ...
         */
        SpatialMappingParameters getSpatialMappingParameters() const;
        ...
        \n The pixel coordinates are expected to be contained x=[0;width-1] and y=[0;height-1], where width/height are defined by the input
        resolution.

        \param[in] coord : The image coordinate. The coordinate must be taken from the full-size image.
        \param[out] plane :  The detected plane if the method succeeded.
        \param[in] parameters :  A structure containing all the specific parameters for the plane detection. Default: a preset of
        PlaneDetectionParameters. \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if a plane is found, otherwise \ref ERROR_CODE
        "ERROR_CODE::PLANE_NOT_FOUND". \note The reference frame is defined by the \ref RuntimeParameters.measure3D_reference_frame given to
        the \ref grab() method.
         */
        ...
        \param[out] floorPlane : The detected floor plane if the method succeeded.
        \param[out] resetTrackingFloorFrame : The transform to align the tracking with the floor plane.
        \n The initial position will then be at ground height, with the axis align with the gravity.
        \n The positional tracking needs to be reset/enabled with this transform as a parameter
        (PositionalTrackingParameters.initial_world_transform).
        \param[in] floor_height_prior : Prior set to locate the floor plane
        depending on the known camera distance to the ground, expressed in the same unit as the ZED. \n If the prior is too far from the
        detected floor plane, the method will return \ref ERROR_CODE "ERROR_CODE::PLANE_NOT_FOUND".
        \param[in] world_orientation_prior : Prior set to locate the floor plane depending on the known camera orientation to the ground. \n
        If the prior is too far from the detected floor plane, the method will return \ref ERROR_CODE "ERROR_CODE::PLANE_NOT_FOUND.
        \param[in] floor_height_prior_tolerance : Prior height tolerance, absolute value.
        \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if the floor plane is found and matches the
        priors (if defined), otherwise \ref ERROR_CODE "ERROR_CODE::PLANE_NOT_FOUND". \note The reference frame is defined by the
        sl::RuntimeParameters (measure3D_reference_frame) given to the grab() method. \note The length unit is defined by sl:InitParameters
        (coordinate_units). \note With the ZED, the assumption is made that the floor plane is the dominant plane in the scene. The ZED Mini
        uses gravity as prior.
         */
        ERROR_CODE findFloorPlane(
            sl::Plane& floorPlane,
        ...
        \n SVO files are custom video files containing the un-rectified images from the camera along with some meta-data like timestamps or
        IMU orientation (if applicable). \n They can be used to simulate a live ZED and test a sequence with various SDK parameters. \n
        Depending on the application, various compression modes are available. See \ref SVO_COMPRESSION_MODE.

        \param recording_parameters : A structure containing all the specific parameters for the recording such as filename and compression
        mode. Default: a reset of RecordingParameters . \return An \ref ERROR_CODE that defines if the SVO file was successfully created and
        can be filled with images.

        \warning This method can be called multiple times during a camera lifetime, but if <b>video_filename</b> is already existing, the
        file will be erased.
        ...
        \param streaming_parameters : A structure containing all the specific parameters for the streaming. Default: a reset of
        StreamingParameters . \return\ref ERROR_CODE "ERROR_CODE::SUCCESS" if streaming was successfully started. \return\ref ERROR_CODE
        "ERROR_CODE::INVALID_FUNCTION_CALL" if open() was not successfully called before. \return\ref ERROR_CODE "ERROR_CODE::FAILURE" if
        streaming RTSP protocol was not able to start. \return\ref ERROR_CODE "ERROR_CODE::NO_GPU_COMPATIBLE" if streaming codec is not
        supported (in this case, use H264 codec which is supported on all NVIDIA GPU the ZED SDK supports).
         ...
         */
        StreamingParameters getStreamingParameters() const;
        ...
        \n The full list of model is available through \ref OBJECT_DETECTION_MODEL and the full list of detectable objects is
        available through \ref OBJECT_CLASS and \ref OBJECT_SUBCLASS.

        \n Detected objects can be retrieved using the \ref retrieveObjects() method.

        \n Alternatively, the object detection module supports custom class of objects with the \ref OBJECT_DETECTION_MODEL
        "OBJECT_DETECTION_MODEL::CUSTOM_BOX_OBJECTS" (see \ref ingestCustomBoxObjects or \ref ingestCustomMaskObjects) or \ref
        OBJECT_DETECTION_MODEL "OBJECT_DETECTION_MODEL::CUSTOM_YOLOLIKE_BOX_OBJECTS" (see \ref ObjectDetectionParameters::custom_onnx_file).

        \n Detected custom objects can be retrieved using the \ref retrieveCustomObjects() method.
        ...
        \param object_detection_parameters : A structure containing all the specific parameters for the object detection. Default: a preset
        of ObjectDetectionParameters. \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if everything went fine. \return \ref ERROR_CODE
        ...
        \return \ref ERROR_CODE "ERROR_CODE::MODULE_NOT_COMPATIBLE_WITH_CAMERA" if the camera used does not have a IMU (\ref MODEL
        "MODEL::ZED"). \return \ref ERROR_CODE "ERROR_CODE::MOTION_SENSORS_REQUIRED" if the camera model is correct (not \ref MODEL
        "MODEL.ZED") but the IMU is missing. It probably happens because InitParameters::sensors_required was set to false and that IMU has
        not been found. \return \ref ERROR_CODE "ERROR_CODE::INVALID_FUNCTION_CALL" if one of the <b>object_detection_parameters</b>
        parameter is not compatible with other modules parameters (for example, <b>depth_mode</b> has been set to \ref DEPTH_MODE
        "DEPTH_MODE::NONE"). \return \ref ERROR_CODE "ERROR_CODE::FAILURE" otherwise.

        \note The IMU gives the gravity vector that helps in the 3D box localization. Therefore the object detection module is not available
        for the \ref MODEL "MODEL::ZED" camera model.
        ...
        \param instance_id : Id of the object detection instance. Used when multiple instances of the object detection module are enabled at
        the same time. \param force_disable_all_instances : Should disable all instances of the object detection module or just
        <b>instance_id</b>.
        ...
        \param instance_id : Id of the object detection instance. Used when multiple instances of the object detection module are enabled at
        the same time. \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if everything went fine.

        \note The detection should be done on the current grabbed left image as the internal process will use all currently available data
        to extract 3D informations and perform object tracking.
         */
        ERROR_CODE ingestCustomBoxObjects(const std::vector<CustomBoxObjectData>& objects_in, const unsigned int instance_id = 0);

        /**
        \brief Feed the 3D Object tracking method with your own 2D bounding boxes with masks from your own detection algorithm.

        \param objects_in : Vector of CustomMaskObjectData to feed the object detection.
        \param instance_id : Id of the object detection instance. Used when multiple instances of the object detection module are enabled at
        the same time. \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if everything went fine.
        ...
        \brief Set the Object detection module instance runtime parameters
         ...
         This can be changed at any time, however since the processing is done in parallel, the parameters will be used for the next
        inference. This function can be called only on parameters change, the previous values will be applied during inference. \param
        params : ObjectDetectionRuntimeParameters parameters \param instance_id : Object detection instance id, by default the first
        instance
         */
        ERROR_CODE setObjectDetectionRuntimeParameters(const ObjectDetectionRuntimeParameters& params, const unsigned int instance_id = 0);

        /**
        \brief Set the Object detection module instance runtime parameters when using the Custom model
        (OBJECT_DETECTION_MODEL::CUSTOM_BOX_OBJECTS and CUSTOM_BOX_OBJECTS::CUSTOM_YOLOLIKE_BOX_OBJECTS) By default the object detection
        module will use the parameters set in the CustomObjectDetectionRuntimeParameters constructor. This can be changed at any time,
        however since the processing is done in parallel, the parameters will be used for the next inference. This function can be called
        only on parameters change, the previous values will be applied during inference. \param params :
        CustomObjectDetectionRuntimeParameters parameters \param instance_id : Object detection instance id, by default the first instance
         */
        ERROR_CODE
        setCustomObjectDetectionRuntimeParameters(const CustomObjectDetectionRuntimeParameters& params, const unsigned int instance_id = 0);

        /**
        \brief Retrieve objects detected by the object detection module.

        This method returns the result of the object detection, this method immediately returns the last objects detected. If the current
        detection isn't done, the objects from the last detection will be returned, and \ref Objects::is_new will be set to false.

        It is recommended to keep the same \ref Objects object as the input of all calls to this method. This will enable the identification
        and tracking of every object detected.
        ...
        it will be updated, keeping a unique ID for the same person. \param instance_id : Id of the object detection instance. Used when
        multiple instances of the object detection module are enabled at the same time. \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if
        everything went fine, \ref ERROR_CODE "ERROR_CODE::FAILURE" otherwise.
        ...
        \endcode
         */
        ERROR_CODE retrieveObjects(Objects& objects, const unsigned int instance_id = 0);
        ...
        \param objects : The detected objects will be saved into this object. If the object already contains data from a previous detection,
        it will be updated, keeping a unique ID for the same person. \param parameters : Object detection runtime settings, can be changed
        at each detection. In async mode, the parameters update is applied on the next iteration. \param instance_id : Id of the object
        detection instance. Used when multiple instances of the object detection module are enabled at the same time. \return \ref
        ERROR_CODE "ERROR_CODE::SUCCESS" if everything went fine, \ref ERROR_CODE "ERROR_CODE::FAILURE" otherwise.

        \deprecated \ref setObjectDetectionRuntimeParameters and \ref retrieveObjects(Objects &objects, const unsigned int instance_id)
        ...
        \endcode
         */
        ERROR_CODE retrieveObjects(Objects& objects, ObjectDetectionRuntimeParameters parameters, const unsigned int instance_id = 0);

        /**
        \brief Retrieve custom objects detected by the object detection module.

        If the object detection module is initialized with \ref OBJECT_DETECTION_MODEL "OBJECT_DETECTION_MODEL::CUSTOM_BOX_OBJECTS", the
        objects retrieved will be the ones from \ref ingestCustomBoxObjects or \ref ingestCustomMaskObjects. If the object detection module
        is initialized with \ref OBJECT_DETECTION_MODEL "OBJECT_DETECTION_MODEL::CUSTOM_YOLOLIKE_BOX_OBJECTS", the objects retrieved will be
        the ones detected using the optimized \ref ObjectDetectionParameters::custom_onnx_file model.

        When running the detection internally, this method returns the result of the object detection, this method immediately returns the
        last objects detected. If the current detection isn't done, the objects from the last detection will be returned, and \ref
        Objects::is_new will be set to false.

        It is recommended to keep the same \ref Objects object as the input of all calls to this method. This will enable the identification
        and tracking of every object detected.

        \param objects : The detected objects will be saved into this object. If the object already contains data from a previous detection,
        it will be updated, keeping a unique ID for the same person. \param parameters : Custom object detection runtime settings, can be
        changed at each detection. In async mode, the parameters update is applied on the next iteration. \param instance_id : Id of the
        object detection instance. Used when multiple instances of the object detection module are enabled at the same time. \return \ref
        ERROR_CODE "ERROR_CODE::SUCCESS" if everything went fine, \ref ERROR_CODE "ERROR_CODE::FAILURE" otherwise.

        \deprecated \ref setCustomObjectDetectionRuntimeParameters and \ref retrieveObjects(Objects &objects, const unsigned int
        instance_id) methods should be used instead
        ...
        while (true) {
            if (zed.grab() == ERROR_CODE::SUCCESS) { // Grab an image from the camera
                zed.retrieveCustomObjects(objects);
                for (auto object : objects.object_list) {
                    std::cout << object.label << std::endl;
                }
            }
         ...
         */
        ERROR_CODE
        retrieveCustomObjects(Objects& objects, CustomObjectDetectionRuntimeParameters parameters, const unsigned int instance_id = 0);
        ...
        \param instance_id : Id of the object detection instance. Used when multiple instances of the object detection module are enabled at
        the same time. \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if everything went fine. \return \ref ERROR_CODE
        ...
        The body tracking module currently supports multiple classes of human skeleton detection with the \ref BODY_TRACKING_MODEL
        "BODY_TRACKING_MODEL::HUMAN_BODY_FAST", \ref BODY_TRACKING_MODEL "BODY_TRACKING_MODEL::HUMAN_BODY_MEDIUM" and \ref
        BODY_TRACKING_MODEL "BODY_TRACKING_MODEL::HUMAN_BODY_ACCURATE". \n This model only detects humans but provides a full skeleton map
        for each person.
        ...
        \param body_tracking_parameters : A structure containing all the specific parameters for the object detection. Default: default
        BodyTrackingParameters. \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if everything went fine. \return \ref ERROR_CODE
        "ERROR_CODE::CORRUPTED_SDK_INSTALLATION" if the AI model is missing or corrupted. In this case, the SDK needs to be reinstalled.
        \return \ref ERROR_CODE "ERROR_CODE::MODULE_NOT_COMPATIBLE_WITH_CAMERA" if the camera used does not have a IMU (\ref MODEL
        "MODEL::ZED"). \return \ref ERROR_CODE "ERROR_CODE::MOTION_SENSORS_REQUIRED" if the camera model is correct (not \ref MODEL
        "MODEL::ZED") but the IMU is missing. It probably happens because InitParameters::sensors_required was set to false and that IMU has
        not been found. \return \ref ERROR_CODE "ERROR_CODE::INVALID_FUNCTION_CALL" if one of the <b>body_tracking_parameters</b> parameter
        is not compatible with other modules parameters (for example, <b>depth_mode</b> has been set to \ref DEPTH_MODE "DEPTH_MODE::NONE").
        ...
        \param instance_id : Id of the body tracking instance. Used when multiple instances of the body tracking module are enabled at the
        same time. \param force_disable_all_instances : Should disable all instances of the tracking module module or just
        <b>instance_id</b>.
        ...
        \brief Set the Body tracking module instance runtime parameters
         ...
         This can be changed at any time, however since the processing is done in parallel, the parameters will be used for the next
        inference. This function can be called only on parameters change, the previous values will be applied during inference. \param
        params : BodyTrackingRuntimeParameters parameters \param instance_id : Body tracking instance id, by default the first instance
         */
        ERROR_CODE setBodyTrackingRuntimeParameters(const BodyTrackingRuntimeParameters& params, const unsigned int instance_id = 0);

        /**
        \brief Retrieves body tracking data from the body tracking module.

        This method returns the result of the body tracking, this method immediately returns the last bodies tracked. If the current
        tracking isn't done, the bodies from the last tracking will be returned, and \ref Bodies::is_new will be set to false.

        It is recommended to keep the same \ref Bodies object as the input of all calls to this method. This will enable the identification
        and the tracking of every detected body.

        \param bodies : The tracked bodies will be saved into this object. If the object already contains data from a previous detection, it
        will be updated, keeping a unique ID for the same person. \param instance_id : Id of the body tracking instance. Used when multiple
        instances of the body tracking module are enabled at the same time. \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if everything went
        fine, \ref ERROR_CODE "ERROR_CODE::FAILURE" otherwise.
         ...
         *
         */
        ERROR_CODE retrieveBodies(Bodies& bodies, unsigned int instance_id = 0);
        ...
        \param bodies : The tracked bodies will be saved into this object. If the object already contains data from a previous detection, it
        will be updated, keeping a unique ID for the same person. \param parameters : Body tracking runtime settings, can be changed at each
        detection. In async mode, the parameters update is applied on the next iteration. \param instance_id : Id of the body tracking
        instance. Used when multiple instances of the body tracking module are enabled at the same time. \return \ref ERROR_CODE
        "ERROR_CODE::SUCCESS" if everything went fine, \ref ERROR_CODE "ERROR_CODE::FAILURE" otherwise.

        \deprecated \ref setBodyTrackingRuntimeParameters and \ref retrieveBodies(Bodies &bodies, const unsigned int instance_id) functions
         ...
         *
         */
        ERROR_CODE retrieveBodies(Bodies& bodies, BodyTrackingRuntimeParameters parameters, unsigned int instance_id = 0);
        ...
        /**
        \brief Returns HealthStatus

        That self diagnostic can be enabled by sl::InitParameters::enable_image_validity_check
         *
        \return \ref HealthStatus Structure containing the self diagnostic results of the image/depth/sensors
         */
        HealthStatus getHealthStatus();

        sl::Resolution getRetrieveImageResolution(sl::Resolution res = sl::Resolution(0, 0));
        sl::Resolution getRetrieveMeasureResolution(sl::Resolution res = sl::Resolution(-1, -1));
        ...
        \warning This method takes around 2 seconds to make sure all network informations has been captured. Make sure to run this method in
        a thread.
        ...
        \warning Under Windows it is not possible to get exclusive access to HID devices, hence calling this method while the camera is
        opened by another process will cause it to freeze for a few seconds while the device is rebooting.
         */

        static sl::ERROR_CODE reboot(int sn, bool fullReboot = true);

        /**
        \brief Performs a hardware reset of all devices matching the InputType.

        \param inputType : Input type of the devices to reset.
        \return \ref ERROR_CODE "ERROR_CODE::SUCCESS" if everything went fine.
        \return \ref ERROR_CODE "ERROR_CODE::CAMERA_NOT_DETECTED" if no camera was detected.
        \return \ref ERROR_CODE "ERROR_CODE::FAILURE" for SVOs otherwise.
    ...
    private:
        ...
        bool opened = false;
        std::unique_ptr<Diagnostic> p_diag;
    };
    ...
    bool /*@cond SHOWHIDDEN*/ SL_SDK_EXPORT /*@endcond*/
    fromString(const sl::String& map_type_str, SpatialMappingParameters::SPATIAL_MAP_TYPE& map_type);
